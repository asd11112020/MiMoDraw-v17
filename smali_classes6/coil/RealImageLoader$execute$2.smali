...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcoil/RealImageLoader$execute$2;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcoil/RealImageLoader$execute$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcoil/RealImageLoader$execute$2;
    ...
    .end local v0    # "this":Lcoil/RealImageLoader$execute$2;
    ...
    .local v1, "this":Lcoil/RealImageLoader$execute$2;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lcoil/RealImageLoader$execute$2;->L$0:Ljava/lang/Object;
    ...
    iget-object v6, v1, Lcoil/RealImageLoader$execute$2;->this$0:Lcoil/RealImageLoader;

    iget-object v7, v1, Lcoil/RealImageLoader$execute$2;->$request:Lcoil/request/ImageRequest;

    const/4 v8, 0x0

    invoke-direct {v3, v6, v7, v8}, Lcoil/RealImageLoader$execute$2$job$1;-><init>(Lcoil/RealImageLoader;Lcoil/request/ImageRequest;Lkotlin/coroutines/Continuation;)V
    ...
    iget-object v3, v1, Lcoil/RealImageLoader$execute$2;->$request:Lcoil/request/ImageRequest;

    invoke-virtual {v3}, Lcoil/request/ImageRequest;->getTarget()Lcoil/target/Target;

    move-result-object v3

    instance-of v3, v3, Lcoil/target/ViewTarget;
    ...
    invoke-static {v3}, Lcoil/util/-Utils;->getRequestManager(Landroid/view/View;)Lcoil/request/ViewTargetRequestManager;

    move-result-object v3

    invoke-virtual {v3, v2}, Lcoil/request/ViewTargetRequestManager;->getDisposable(Lkotlinx/coroutines/Deferred;)Lcoil/request/ViewTargetDisposable;
    ...
    iput v4, v1, Lcoil/RealImageLoader$execute$2;->label:I
    ...
    .end local v1    # "this":Lcoil/RealImageLoader$execute$2;
    .restart local v0    # "this":Lcoil/RealImageLoader$execute$2;
    :goto_0
    return-object v2
