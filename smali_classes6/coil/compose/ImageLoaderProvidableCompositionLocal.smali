...
.method public static final getCurrent(Landroidx/compose/runtime/ProvidableCompositionLocal;Landroidx/compose/runtime/Composer;I)Lcoil/ImageLoader;
    ...
    .local v0, "$this$imageLoader$iv":Landroid/content/Context;
    const/4 v1, 0x0

    .line 57
    .local v1, "$i$f$getImageLoader":I
    invoke-static {v0}, Lcoil/Coil;->imageLoader(Landroid/content/Context;)Lcoil/ImageLoader;

    move-result-object v5

    .line 50
    .end local v0    # "$this$imageLoader$iv":Landroid/content/Context;
    .end local v1    # "$i$f$getImageLoader":I
    :cond_1
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
