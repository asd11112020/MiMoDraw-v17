...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 653
    .local v2, "$i$a$-synchronized-DiskLruCache$launchCleanup$1$1":I
    :try_start_0
    invoke-static {v1}, Lcoil/disk/DiskLruCache;->access$getInitialized$p(Lcoil/disk/DiskLruCache;)Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-static {v1}, Lcoil/disk/DiskLruCache;->access$getClosed$p(Lcoil/disk/DiskLruCache;)Z
    ...
    :try_start_1
    invoke-static {v1}, Lcoil/disk/DiskLruCache;->access$trimToSize(Lcoil/disk/DiskLruCache;)V
    :try_end_1
    ...
    .line 657
    :try_start_2
    invoke-static {v1, v3}, Lcoil/disk/DiskLruCache;->access$setMostRecentTrimFailed$p(Lcoil/disk/DiskLruCache;Z)V
    :try_end_2
    ...
    .line 660
    :try_start_3
    invoke-static {v1}, Lcoil/disk/DiskLruCache;->access$journalRewriteRequired(Lcoil/disk/DiskLruCache;)Z
    ...
    .line 661
    invoke-static {v1}, Lcoil/disk/DiskLruCache;->access$writeJournal(Lcoil/disk/DiskLruCache;)V
    :try_end_3
    ...
    .line 664
    :try_start_4
    invoke-static {v1, v3}, Lcoil/disk/DiskLruCache;->access$setMostRecentRebuildFailed$p(Lcoil/disk/DiskLruCache;Z)V
    ...
    invoke-static {v1, v3}, Lcoil/disk/DiskLruCache;->access$setJournalWriter$p(Lcoil/disk/DiskLruCache;Lokio/BufferedSink;)V
    ...
    .end local v2    # "$i$a$-synchronized-DiskLruCache$launchCleanup$1$1":I
    ...
    .line 653
    .restart local v2    # "$i$a$-synchronized-DiskLruCache$launchCleanup$1$1":I
    :cond_2
    :goto_2
    :try_start_5
