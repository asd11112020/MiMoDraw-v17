...
.method private final complete(Z)V
    ...
    .line 766
    .local v1, "$i$a$-synchronized-DiskLruCache$Editor$complete$1":I
    :try_start_0
    iget-boolean v2, p0, Lcoil/disk/DiskLruCache$Editor;->closed:Z
    ...
    .line 767
    iget-object v2, p0, Lcoil/disk/DiskLruCache$Editor;->entry:Lcoil/disk/DiskLruCache$Entry;
    ...
    .line 770
    :cond_0
    iput-boolean v3, p0, Lcoil/disk/DiskLruCache$Editor;->closed:Z

    .line 771
    nop

    .end local v1    # "$i$a$-synchronized-DiskLruCache$Editor$complete$1":I
    ...
    .line 870
    .restart local v1    # "$i$a$-synchronized-DiskLruCache$Editor$complete$1":I
    :cond_1
    const/4 v2, 0x0

    .line 766
    .local v2, "$i$a$-check-DiskLruCache$Editor$complete$1$1":I
    :try_start_1
    const-string v3, "editor is closed"

    .end local v2    # "$i$a$-check-DiskLruCache$Editor$complete$1$1":I
...
.method public final commitAndGet()Lcoil/disk/DiskLruCache$Snapshot;
    ...
    .line 750
    .local v1, "$i$a$-synchronized-DiskLruCache$Editor$commitAndGet$1":I
    :try_start_0
    ...
    invoke-virtual {v2}, Lcoil/disk/DiskLruCache$Entry;->getKey()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcoil/disk/DiskLruCache;->get(Ljava/lang/String;)Lcoil/disk/DiskLruCache$Snapshot;

    move-result-object v2
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .end local v1    # "$i$a$-synchronized-DiskLruCache$Editor$commitAndGet$1":I
    monitor-exit v0
...
.method public final file(I)Lokio/Path;
    ...
    .line 723
    .local v1, "$i$a$-synchronized-DiskLruCache$Editor$file$1":I
    :try_start_0
    iget-boolean v2, p0, Lcoil/disk/DiskLruCache$Editor;->closed:Z
    ...
    .line 724
    iget-object v2, p0, Lcoil/disk/DiskLruCache$Editor;->written:[Z
    ...
    invoke-virtual {v2}, Lcoil/disk/DiskLruCache$Entry;->getDirtyFiles()Ljava/util/ArrayList;
    ...
    invoke-static {v3, v4}, Lcoil/util/-FileSystems;->createFile(Lokio/FileSystem;Lokio/Path;)V
    ...
    .end local v1    # "$i$a$-synchronized-DiskLruCache$Editor$file$1":I
    monitor-exit v0

    return-object v2

    .line 870
    .restart local v1    # "$i$a$-synchronized-DiskLruCache$Editor$file$1":I
    :cond_0
    const/4 v2, 0x0

    .line 723
    .local v2, "$i$a$-check-DiskLruCache$Editor$file$1$1":I
    :try_start_1
    const-string v3, "editor is closed"

    .end local v2    # "$i$a$-check-DiskLruCache$Editor$file$1$1":I
    new-instance v2, Ljava/lang/IllegalStateException;
