...
.method public close()V
    ...
    .line 691
    .local v1, "$i$a$-synchronized-DiskLruCache$Snapshot$close$1":I
    :try_start_0
    iget-object v2, p0, Lcoil/disk/DiskLruCache$Snapshot;->entry:Lcoil/disk/DiskLruCache$Entry;

    invoke-virtual {v2}, Lcoil/disk/DiskLruCache$Entry;->getLockingSnapshotCount()I

    move-result v3

    add-int/lit8 v3, v3, -0x1

    invoke-virtual {v2, v3}, Lcoil/disk/DiskLruCache$Entry;->setLockingSnapshotCount(I)V
    ...
    invoke-virtual {v2}, Lcoil/disk/DiskLruCache$Entry;->getZombie()Z
    ...
    invoke-static {v0, v2}, Lcoil/disk/DiskLruCache;->access$removeEntry(Lcoil/disk/DiskLruCache;Lcoil/disk/DiskLruCache$Entry;)Z

    .line 695
    :cond_0
    nop

    .end local v1    # "$i$a$-synchronized-DiskLruCache$Snapshot$close$1":I
...
.method public final closeAndEdit()Lcoil/disk/DiskLruCache$Editor;
    ...
    .line 701
    .local v1, "$i$a$-synchronized-DiskLruCache$Snapshot$closeAndEdit$1":I
    :try_start_0
    ...
    invoke-virtual {v0, v2}, Lcoil/disk/DiskLruCache;->edit(Ljava/lang/String;)Lcoil/disk/DiskLruCache$Editor;

    move-result-object v2
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .end local v1    # "$i$a$-synchronized-DiskLruCache$Snapshot$closeAndEdit$1":I
    monitor-exit v0
