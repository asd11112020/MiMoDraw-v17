...
.method private static final boundsOfLayoutNode(Landroidx/compose/ui/layout/LayoutInfo;)Landroidx/compose/ui/unit/IntRect;
    ...
    .line 575
    .local v8, "bottom":I
    new-instance v9, Landroidx/compose/ui/unit/IntRect;

    invoke-direct {v9, v5, v6, v7, v8}, Landroidx/compose/ui/unit/IntRect;-><init>(IIII)V
...
.method private static final extractParameterInfo(Ljava/util/List;Landroidx/compose/ui/tooling/data/SourceInformationContext;)Ljava/util/List;
    ...
    .line 798
    .local v9, "$i$a$-firstOrNull-SlotTreeKt$extractParameterInfo$recomposeScope$1":I
    if-eqz v8, :cond_1
    ...
    invoke-static {v10, v11, v7, v5, v6}, Lkotlin/text/StringsKt;->endsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    .end local v9    # "$i$a$-firstOrNull-SlotTreeKt$extractParameterInfo$recomposeScope$1":I
    :goto_0
    if-eqz v8, :cond_0
    ...
    .line 800
    .local v2, "recomposeScope":Ljava/lang/Object;
    if-eqz v2, :cond_14
    ...
    invoke-static {v0, v3}, Landroidx/compose/ui/tooling/data/SlotTreeKt;->accessibleField(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v0

    .line 803
    .local v0, "blockField":Ljava/lang/reflect/Field;
    if-eqz v0, :cond_13
    ...
    .line 805
    .local v3, "block":Ljava/lang/Object;
    if-eqz v3, :cond_12
    ...
    .line 807
    .local v4, "blockClass":Ljava/lang/Class;
    const-string v8, "$$default"

    invoke-static {v4, v8}, Landroidx/compose/ui/tooling/data/SlotTreeKt;->accessibleField(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v8

    .line 808
    .local v8, "defaultsField":Ljava/lang/reflect/Field;
    const-string v9, "$$changed"

    invoke-static {v4, v9}, Landroidx/compose/ui/tooling/data/SlotTreeKt;->accessibleField(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    .line 810
    .local v9, "changedField":Ljava/lang/reflect/Field;
    ...
    .line 851
    .end local v0    # "blockField":Ljava/lang/reflect/Field;
    .end local v3    # "block":Ljava/lang/Object;
    .end local v4    # "blockClass":Ljava/lang/Class;
    .end local v8    # "defaultsField":Ljava/lang/reflect/Field;
    .end local v9    # "changedField":Ljava/lang/reflect/Field;
    :catchall_0
    move-exception v0
    ...
    .line 810
    .restart local v0    # "blockField":Ljava/lang/reflect/Field;
    .restart local v3    # "block":Ljava/lang/Object;
    .restart local v4    # "blockClass":Ljava/lang/Class;
    .restart local v8    # "defaultsField":Ljava/lang/reflect/Field;
    .restart local v9    # "changedField":Ljava/lang/reflect/Field;
    :cond_3
    move v11, v7
    ...
    .local v12, "$this$filter$iv":[Ljava/lang/Object;
    const/4 v13, 0x0
    ...
    .local v15, "$this$filterTo$iv$iv":[Ljava/lang/Object;
    const/16 v16, 0x0
    ...
    .local v18, "it":Ljava/lang/reflect/Field;
    .local v19, "element$iv$iv":Ljava/lang/Object;
    const/16 v20, 0x0

    .line 815
    .local v20, "$i$a$-filter-SlotTreeKt$extractParameterInfo$fields$1":I
    ...
    .end local v0    # "blockField":Ljava/lang/reflect/Field;
    .end local v2    # "recomposeScope":Ljava/lang/Object;
    .local v22, "blockField":Ljava/lang/reflect/Field;
    .local v23, "recomposeScope":Ljava/lang/Object;
    :try_start_3
    invoke-static {v6, v7, v2, v0, v1}, Lkotlin/text/StringsKt;->startsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    .line 901
    .end local v18    # "it":Ljava/lang/reflect/Field;
    .end local v20    # "$i$a$-filter-SlotTreeKt$extractParameterInfo$fields$1":I
    if-eqz v0, :cond_6
    ...
    .line 902
    .end local v22    # "blockField":Ljava/lang/reflect/Field;
    .end local v23    # "recomposeScope":Ljava/lang/Object;
    .local v0, "blockField":Ljava/lang/reflect/Field;
    .restart local v2    # "recomposeScope":Ljava/lang/Object;
    :cond_7
    move-object/from16 v22, v0
    ...
    .end local v15    # "$this$filterTo$iv$iv":[Ljava/lang/Object;
    .end local v16    # "$i$f$filterTo":I
    .restart local v22    # "blockField":Ljava/lang/reflect/Field;
    ...
    .end local v12    # "$this$filter$iv":[Ljava/lang/Object;
    ...
    new-instance v5, Landroidx/compose/ui/tooling/data/SlotTreeKt$extractParameterInfo$$inlined$sortedBy$1;

    invoke-direct {v5}, Landroidx/compose/ui/tooling/data/SlotTreeKt$extractParameterInfo$$inlined$sortedBy$1;-><init>()V
    ...
    .line 821
    .local v5, "parametersMetadata":Ljava/util/List;
    :cond_9
    ...
    .line 822
    .local v13, "$i$a$-repeat-SlotTreeKt$extractParameterInfo$1":I
    ...
    check-cast v14, Landroidx/compose/ui/tooling/data/Parameter;
    ...
    :cond_a
    new-instance v14, Landroidx/compose/ui/tooling/data/Parameter;

    const/4 v2, 0x0

    const/4 v15, 0x2

    invoke-direct {v14, v12, v2, v15, v2}, Landroidx/compose/ui/tooling/data/Parameter;-><init>(ILjava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 824
    .local v14, "metadata":Landroidx/compose/ui/tooling/data/Parameter;
    invoke-virtual {v14}, Landroidx/compose/ui/tooling/data/Parameter;->getSortedIndex()I
    ...
    .line 833
    .local v18, "parameterChanged":I
    move-object/from16 v19, v0

    .end local v0    # "fields":Ljava/util/List;
    .local v19, "fields":Ljava/util/List;
    and-int/lit8 v0, v18, 0x3

    move-object/from16 v20, v3

    .end local v3    # "block":Ljava/lang/Object;
    .local v20, "block":Ljava/lang/Object;
    const/4 v3, 0x3
    ...
    .line 837
    new-instance v3, Landroidx/compose/ui/tooling/data/ParameterInformation;

    .line 838
    move-object/from16 v32, v4

    .end local v4    # "blockClass":Ljava/lang/Class;
    .local v32, "blockClass":Ljava/lang/Class;
    ...
    .line 843
    :goto_d
    invoke-virtual {v14}, Landroidx/compose/ui/tooling/data/Parameter;->getInlineClass()Ljava/lang/String;
    ...
    invoke-direct/range {v24 .. v31}, Landroidx/compose/ui/tooling/data/ParameterInformation;-><init>(Ljava/lang/String;Ljava/lang/Object;ZZZLjava/lang/String;Z)V
    ...
    .line 824
    .end local v15    # "fromDefault":Z
    .end local v16    # "changedOffset":I
    .end local v18    # "parameterChanged":I
    .end local v19    # "fields":Ljava/util/List;
    .end local v20    # "block":Ljava/lang/Object;
    .end local v26    # "value":Ljava/lang/Object;
    .end local v28    # "static":Z
    .end local v31    # "stable":Z
    .end local v32    # "blockClass":Ljava/lang/Class;
    ...
    .end local v13    # "$i$a$-repeat-SlotTreeKt$extractParameterInfo$1":I
    .end local v14    # "metadata":Landroidx/compose/ui/tooling/data/Parameter;
    .restart local v19    # "fields":Ljava/util/List;
    .restart local v20    # "block":Ljava/lang/Object;
    .restart local v32    # "blockClass":Ljava/lang/Class;
    :goto_e
    ...
    .end local v3    # "block":Ljava/lang/Object;
    .end local v4    # "blockClass":Ljava/lang/Class;
    .end local v5    # "parametersMetadata":Ljava/util/List;
    .end local v8    # "defaultsField":Ljava/lang/reflect/Field;
    .end local v9    # "changedField":Ljava/lang/reflect/Field;
    .end local v10    # "changed":I
    .end local v11    # "default":I
    .end local v22    # "blockField":Ljava/lang/reflect/Field;
    :catchall_1
    move-exception v0
