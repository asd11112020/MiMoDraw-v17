...
.method private final findAnimations(Ljava/util/Collection;)Ljava/util/List;
    ...
    :goto_4
    instance-of v2, v1, Landroidx/compose/animation/core/InfiniteTransition;
    ...
    invoke-direct {v0, v2}, Landroidx/compose/ui/tooling/animation/AnimationSearch$InfiniteTransitionSearch;->findToolingOverride(Landroidx/compose/ui/tooling/data/Group;)Landroidx/compose/runtime/MutableState;

    move-result-object v2

    .line 246
    .local v2, "toolingOverride":Landroidx/compose/runtime/MutableState;
    if-eqz v1, :cond_9
    ...
    invoke-direct {v4, v0}, Landroidx/compose/ui/tooling/animation/ToolingState;-><init>(Ljava/lang/Object;)V
    ...
    instance-of v14, v4, Landroidx/compose/ui/tooling/animation/ToolingState;
    ...
    .line 250
    :goto_5
    invoke-direct {v0, v1, v4}, Landroidx/compose/ui/tooling/animation/AnimationSearch$InfiniteTransitionSearchInfo;-><init>(Landroidx/compose/animation/core/InfiniteTransition;Landroidx/compose/ui/tooling/animation/ToolingState;)V
    ...
    .end local v2    # "toolingOverride":Landroidx/compose/runtime/MutableState;
...
.method private final findToolingOverride(Landroidx/compose/ui/tooling/data/Group;)Landroidx/compose/runtime/MutableState;
    ...
    .local v4, "$this$flatMap$iv$iv":Ljava/lang/Iterable;
    const/4 v5, 0x0
    ...
    .line 510
    .local v11, "list$iv$iv$iv":Ljava/lang/Iterable;
    ...
    .end local v11    # "list$iv$iv$iv":Ljava/lang/Iterable;
    :cond_1
    nop
    ...
    .end local v4    # "$this$flatMap$iv$iv":Ljava/lang/Iterable;
