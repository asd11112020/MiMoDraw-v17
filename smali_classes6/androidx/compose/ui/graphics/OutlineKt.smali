...
.method public static final drawOutline-hn5TExg(Landroidx/compose/ui/graphics/drawscope/DrawScope;Landroidx/compose/ui/graphics/Outline;Landroidx/compose/ui/graphics/Brush;FLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    .local v13, "$this$drawOutlineHelper$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/4 v14, 0x0

    .line 323
    .local v14, "$i$f$drawOutlineHelper":I
    nop
    ...
    .local v11, "rect":Landroidx/compose/ui/geometry/Rect;
    move-object v1, v13

    .local v1, "$this$drawOutline_hn5TExg_u24lambda_u243":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/4 v12, 0x0

    .line 197
    .local v12, "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$4":I
    invoke-static {v11}, Landroidx/compose/ui/graphics/OutlineKt;->topLeft(Landroidx/compose/ui/geometry/Rect;)J

    move-result-wide v3

    invoke-static {v11}, Landroidx/compose/ui/graphics/OutlineKt;->size(Landroidx/compose/ui/geometry/Rect;)J
    ...
    .line 324
    .end local v1    # "$this$drawOutline_hn5TExg_u24lambda_u243":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v11    # "rect":Landroidx/compose/ui/geometry/Rect;
    .end local v12    # "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$4":I
    goto/16 :goto_0
    ...
    .line 331
    .local v15, "path$iv":Landroidx/compose/ui/graphics/Path;
    if-eqz v15, :cond_1

    .line 332
    move-object v1, v13

    .local v1, "$this$drawOutline_hn5TExg_u24lambda_u245":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    move-object v2, v15
    ...
    .line 212
    .local v8, "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$6":I
    ...
    .line 332
    .end local v1    # "$this$drawOutline_hn5TExg_u24lambda_u245":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v2    # "path":Landroidx/compose/ui/graphics/Path;
    .end local v8    # "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$6":I
    goto :goto_0
    ...
    .local v16, "rrect":Landroidx/compose/ui/geometry/RoundRect;
    move-object v1, v13

    .local v1, "$this$drawOutline_hn5TExg_u24lambda_u244":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/16 v17, 0x0

    .line 200
    .local v17, "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$5":I
    invoke-virtual/range {v16 .. v16}, Landroidx/compose/ui/geometry/RoundRect;->getBottomLeftCornerRadius-kKHJgLs()J
    ...
    .line 203
    invoke-static/range {v16 .. v16}, Landroidx/compose/ui/graphics/OutlineKt;->topLeft(Landroidx/compose/ui/geometry/RoundRect;)J

    move-result-wide v3

    .line 204
    invoke-static/range {v16 .. v16}, Landroidx/compose/ui/graphics/OutlineKt;->size(Landroidx/compose/ui/geometry/RoundRect;)J
    ...
    invoke-static {v12, v8, v2, v7}, Landroidx/compose/ui/geometry/CornerRadiusKt;->CornerRadius$default(FFILjava/lang/Object;)J
    ...
    .line 334
    .end local v1    # "$this$drawOutline_hn5TExg_u24lambda_u244":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v16    # "rrect":Landroidx/compose/ui/geometry/RoundRect;
    .end local v17    # "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$5":I
    .end local v18    # "radius":F
    nop

    .end local v15    # "path$iv":Landroidx/compose/ui/graphics/Path;
    goto :goto_0
    ...
    .line 212
    .local v9, "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$6":I
    move-object v2, v8
    ...
    .end local v9    # "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$6":I
    nop
    ...
    .line 213
    .end local v13    # "$this$drawOutlineHelper$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v14    # "$i$f$drawOutlineHelper":I
    return-void

    .line 337
    .restart local v13    # "$this$drawOutlineHelper$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v14    # "$i$f$drawOutlineHelper":I
    :cond_3
...
.method public static final drawOutline-wDX37Ww(Landroidx/compose/ui/graphics/drawscope/DrawScope;Landroidx/compose/ui/graphics/Outline;JFLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    .local v14, "$this$drawOutlineHelper$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/4 v15, 0x0

    .line 307
    .local v15, "$i$f$drawOutlineHelper":I
    nop
    ...
    .local v1, "$this$drawOutline_wDX37Ww_u24lambda_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/4 v13, 0x0

    .line 158
    .local v13, "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$1":I
    invoke-static {v12}, Landroidx/compose/ui/graphics/OutlineKt;->topLeft(Landroidx/compose/ui/geometry/Rect;)J

    move-result-wide v4

    invoke-static {v12}, Landroidx/compose/ui/graphics/OutlineKt;->size(Landroidx/compose/ui/geometry/Rect;)J
    ...
    .line 308
    .end local v1    # "$this$drawOutline_wDX37Ww_u24lambda_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v12    # "rect":Landroidx/compose/ui/geometry/Rect;
    .end local v13    # "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$1":I
    goto/16 :goto_0
    ...
    .line 315
    .local v16, "path$iv":Landroidx/compose/ui/graphics/Path;
    if-eqz v16, :cond_1

    .line 316
    move-object v1, v14

    .local v1, "$this$drawOutline_wDX37Ww_u24lambda_u242":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    ...
    .line 173
    .local v9, "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$3":I
    ...
    .line 316
    .end local v1    # "$this$drawOutline_wDX37Ww_u24lambda_u242":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v2    # "path":Landroidx/compose/ui/graphics/Path;
    .end local v9    # "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$3":I
    goto :goto_0
    ...
    .local v17, "rrect":Landroidx/compose/ui/geometry/RoundRect;
    move-object v1, v14

    .local v1, "$this$drawOutline_wDX37Ww_u24lambda_u241":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/16 v18, 0x0

    .line 161
    .local v18, "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$2":I
    invoke-virtual/range {v17 .. v17}, Landroidx/compose/ui/geometry/RoundRect;->getBottomLeftCornerRadius-kKHJgLs()J
    ...
    .line 164
    .local v13, "radius":F
    invoke-static/range {v17 .. v17}, Landroidx/compose/ui/graphics/OutlineKt;->topLeft(Landroidx/compose/ui/geometry/RoundRect;)J

    move-result-wide v4

    .line 165
    invoke-static/range {v17 .. v17}, Landroidx/compose/ui/graphics/OutlineKt;->size(Landroidx/compose/ui/geometry/RoundRect;)J
    ...
    invoke-static {v13, v8, v2, v3}, Landroidx/compose/ui/geometry/CornerRadiusKt;->CornerRadius$default(FFILjava/lang/Object;)J
    ...
    invoke-interface/range {v1 .. v13}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->drawRoundRect-u-Aw5IA(JJJJLandroidx/compose/ui/graphics/drawscope/DrawStyle;FLandroidx/compose/ui/graphics/ColorFilter;I)V

    .line 172
    nop

    .line 318
    .end local v1    # "$this$drawOutline_wDX37Ww_u24lambda_u241":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v17    # "rrect":Landroidx/compose/ui/geometry/RoundRect;
    .end local v18    # "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$2":I
    .end local v19    # "radius":F
    nop

    .end local v16    # "path$iv":Landroidx/compose/ui/graphics/Path;
    goto :goto_0
    ...
    .line 173
    .local v10, "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$3":I
    move-object v2, v9
    ...
    .end local v10    # "$i$a$-drawOutlineHelper-OutlineKt$drawOutline$3":I
    nop
    ...
    .line 174
    .end local v14    # "$this$drawOutlineHelper$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v15    # "$i$f$drawOutlineHelper":I
    return-void

    .line 321
    .restart local v14    # "$this$drawOutlineHelper$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v15    # "$i$f$drawOutlineHelper":I
    :cond_3
    new-instance v1, Lkotlin/NoWhenBranchMatchedException;
