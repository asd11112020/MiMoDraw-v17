...
.method public static final nextFloat(Ljava/lang/String;II)J
    ...
    .restart local v8    # "value$iv":F
    const/4 v9, 0x0

    .line 628
    .restart local v9    # "$i$f$pack":I
    int-to-long v12, v6
    ...
    .line 81
    .local v14, "significand":J
    move v9, v6

    .line 84
    .local v9, "significandStartIndex":I
    ...
    .line 92
    .local v3, "significandEndIndex":I
    sub-int v4, v6, v9
    ...
    .line 630
    .local v12, "$i$f$parseFourDigits":I
    invoke-virtual {v0, v6}, Ljava/lang/String;->charAt(I)C
    ...
    .line 104
    .end local v7    # "base$iv":J
    .end local v12    # "$i$f$parseFourDigits":I
    ...
    .restart local v32    # "c":C
    .restart local v33    # "exponent":I
    :cond_a
    move/from16 v6, v31
    ...
    .end local v5    # "$this$isDigit$iv":C
    ...
    .end local v14    # "significand":J
    .local v15, "$i$f$pack":I
    .local v31, "significand":J
    int-to-long v13, v6
    ...
    .end local v15    # "$i$f$pack":I
    .local v16, "$i$f$pack":I
    ...
    .end local v11    # "isNegative":Z
    .end local v12    # "value$iv":F
    .local v17, "value$iv":F
    .local v24, "isNegative":Z
    int-to-long v11, v15
    ...
    .line 122
    .end local v16    # "$i$f$pack":I
    .end local v17    # "value$iv":F
    return-wide v11

    .line 125
    .end local v24    # "isNegative":Z
    .end local v31    # "significand":J
    .restart local v11    # "isNegative":Z
    .restart local v14    # "significand":J
    :cond_11
    move/from16 v24, v11
    ...
    .end local v11    # "isNegative":Z
    .end local v14    # "significand":J
    .restart local v24    # "isNegative":Z
    .restart local v31    # "significand":J
    const/4 v11, 0x0

    .line 126
    .local v11, "exponentNumber":I
    ...
    .line 131
    .local v12, "isExponentNegative":Z
    :goto_e
    if-nez v12, :cond_14
    ...
    .end local v13    # "$this$isDigit$iv":C
    .local v33, "$this$isDigit$iv":C
    ...
    .end local v15    # "$i$f$isDigit":I
    .end local v33    # "$this$isDigit$iv":C
    :goto_10
    if-eqz v14, :cond_19
    ...
    .line 150
    .end local v12    # "isExponentNegative":Z
    :cond_1b
    const/4 v12, 0x0

    .line 153
    .local v12, "tooManyDigits":Z
    const/16 v13, 0x13
    ...
    .end local v8    # "exponent":I
    .end local v9    # "significandStartIndex":I
    .local v28, "significandStartIndex":I
    ...
    .line 183
    .end local v8    # "exponent":I
    .restart local v29    # "exponent":I
    :cond_22
    move/from16 v1, v23

    .line 184
    .end local v13    # "retryIndex":I
    .local v1, "retryIndex":I
    ...
    .end local v3    # "significandEndIndex":I
    .local v13, "significandEndIndex":I
    invoke-static {v14, v15}, Lkotlin/ULong;->constructor-impl(J)J

    move-result-wide v2

    invoke-static {v2, v3, v8, v9}, Ljava/lang/Long;->compareUnsigned(JJ)I
    ...
    .line 187
    .end local v13    # "significandEndIndex":I
    .restart local v3    # "significandEndIndex":I
    :cond_24
    move v13, v3

    .line 194
    .end local v3    # "significandEndIndex":I
    .restart local v13    # "significandEndIndex":I
    :cond_25
    sub-int v2, v23, v1
    ...
    .line 164
    .end local v1    # "retryIndex":I
    .end local v13    # "significandEndIndex":I
    .end local v28    # "significandStartIndex":I
    .restart local v3    # "significandEndIndex":I
    .restart local v9    # "significandStartIndex":I
    .local v14, "retryIndex":I
    .restart local v31    # "significand":J
    :cond_26
    move v13, v3
    ...
    .end local v9    # "significandStartIndex":I
    .restart local v13    # "significandEndIndex":I
    .restart local v28    # "significandStartIndex":I
    .restart local v29    # "exponent":I
    ...
    .line 211
    .end local v16    # "$i$f$pack":I
    .end local v18    # "value$iv":F
    return-wide v1

    .line 201
    .end local v9    # "digitCount":I
    .end local v17    # "f":F
    .restart local v4    # "digitCount":I
    :cond_2b
    move v9, v4

    .end local v4    # "digitCount":I
    .restart local v9    # "digitCount":I
    goto :goto_1d
    ...
    .end local v5    # "exponentEndIndex":I
    .local v18, "exponentEndIndex":I
    invoke-static {v1}, Ljava/lang/Float;->floatToRawIntBits(F)I
    ...
    .line 225
    .end local v18    # "exponentEndIndex":I
    .end local v19    # "dataLength":I
    .end local v29    # "digitCount":I
    .restart local v5    # "exponentEndIndex":I
    .restart local v9    # "digitCount":I
    ...
    .end local v9    # "digitCount":I
    .end local v10    # "dataLength":I
    .restart local v18    # "exponentEndIndex":I
    .restart local v19    # "dataLength":I
    .restart local v29    # "digitCount":I
    ...
    .line 647
    .local v14, "$i$f$fullMultiplicationHighBits":I
    ...
    .line 650
    .local v35, "yLo$iv":J
    ushr-long v15, v3, v30

    .line 652
    .local v15, "yHi$iv":J
    mul-long v37, v33, v15

    .line 653
    .local v37, "xTimesYHi$iv":J
    mul-long v39, v31, v15

    .line 654
    .local v39, "xTimesYMid$iv":J
    mul-long v41, v33, v35

    .line 655
    .local v41, "yTimesXMid$iv":J
    mul-long v43, v31, v35

    .line 658
    .local v43, "xTimesYLo$iv":J
    nop
    ...
    .line 658
    add-long v45, v41, v45

    .line 660
    const-wide v20, 0xffffffffL

    and-long v47, v39, v20
    ...
    .line 662
    .local v45, "carry$iv":J
    ushr-long v47, v45, v30

    add-long v47, v37, v47

    ushr-long v49, v39, v30

    add-long v47, v47, v49

    .line 229
    .end local v14    # "$i$f$fullMultiplicationHighBits":I
    .end local v15    # "yHi$iv":J
    .end local v31    # "xLo$iv":J
    .end local v33    # "xHi$iv":J
    .end local v35    # "yLo$iv":J
    .end local v37    # "xTimesYHi$iv":J
    .end local v39    # "xTimesYMid$iv":J
    .end local v41    # "yTimesXMid$iv":J
    .end local v43    # "xTimesYLo$iv":J
    .end local v45    # "carry$iv":J
    ...
    .end local v3    # "significandFactor":J
    .local v31, "significandFactor":J
    const/16 v3, 0x3f
    ...
    .line 234
    const-wide/16 v35, 0x1ff

    and-long v37, v14, v35

    cmp-long v16, v37, v35

    if-eqz v16, :cond_37

    and-long v35, v14, v35

    cmp-long v16, v35, v26
    ...
    .line 248
    const-wide/32 v16, 0x3526a

    move/from16 v37, v4

    .end local v4    # "upperBit":I
    .local v37, "upperBit":I
    int-to-long v3, v8
    ...
    .line 665
    .local v1, "$i$f$doubleFromBits":I
    move-wide/from16 v25, v3

    .end local v3    # "adjustedExponent":J
    .local v25, "adjustedExponent":J
    invoke-static {v9, v10}, Ljava/lang/Double;->longBitsToDouble(J)D

    move-result-wide v3

    .line 257
    .end local v1    # "$i$f$doubleFromBits":I
    ...
    .end local v7    # "realExponent":J
    .local v35, "realExponent":J
    int-to-long v7, v5
    ...
    .line 257
    .end local v1    # "value$iv":F
    .end local v22    # "$i$f$pack":I
    return-wide v3

    .line 250
    .end local v25    # "adjustedExponent":J
    .end local v27    # "lz":I
    .end local v35    # "realExponent":J
    .local v3, "adjustedExponent":J
    .restart local v5    # "lz":I
    .restart local v7    # "realExponent":J
    :cond_36
    move-wide/from16 v25, v3
    ...
    .end local v5    # "lz":I
    .end local v7    # "realExponent":J
    .restart local v25    # "adjustedExponent":J
    .restart local v27    # "lz":I
    .restart local v35    # "realExponent":J
    :goto_20
    invoke-virtual {v0, v2, v6}, Ljava/lang/String;->substring(II)Ljava/lang/String;
    ...
    .line 234
    .end local v16    # "c":C
    .end local v17    # "exponent":I
    .end local v25    # "adjustedExponent":J
    .end local v27    # "lz":I
    .end local v35    # "realExponent":J
    .end local v37    # "upperBit":I
    .restart local v4    # "upperBit":I
    .restart local v5    # "lz":I
    .local v7, "c":C
    .restart local v8    # "exponent":I
    :cond_37
    ...
    .restart local v17    # "exponent":I
    .restart local v37    # "upperBit":I
    :goto_21
    invoke-virtual {v0, v2, v6}, Ljava/lang/String;->substring(II)Ljava/lang/String;
