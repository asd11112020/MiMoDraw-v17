...
.method public draw(Landroidx/compose/ui/graphics/drawscope/DrawScope;)V
    ...
    .local v8, "$this$draw_u24lambda_u244":Landroidx/compose/ui/graphics/drawscope/DrawTransform;
    const/4 v9, 0x0

    .line 610
    .local v9, "$i$a$-withTransform-GroupComponent$draw$1":I
    iget-object v10, v0, Landroidx/compose/ui/graphics/vector/GroupComponent;->groupMatrix:[F
    ...
    invoke-interface {v8, v10}, Landroidx/compose/ui/graphics/drawscope/DrawTransform;->transform-58bKbWc([F)V

    .line 611
    .end local v10    # "it":[F
    .end local v12    # "$i$a$-let-GroupComponent$draw$1$1":I
    :cond_3
    iget-object v10, v0, Landroidx/compose/ui/graphics/vector/GroupComponent;->clipPath:Landroidx/compose/ui/graphics/Path;
    ...
    invoke-static {v8, v10, v2, v12, v11}, Landroidx/compose/ui/graphics/drawscope/DrawTransform;->clipPath-mtrdD-E$default(Landroidx/compose/ui/graphics/drawscope/DrawTransform;Landroidx/compose/ui/graphics/Path;IILjava/lang/Object;)V
    ...
    .line 660
    .end local v8    # "$this$draw_u24lambda_u244":Landroidx/compose/ui/graphics/drawscope/DrawTransform;
    ...
    .local v2, "$this$draw_u24lambda_u247":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/4 v8, 0x0

    .line 616
    .local v8, "$i$a$-withTransform-GroupComponent$draw$2":I
    iget-object v9, v0, Landroidx/compose/ui/graphics/vector/GroupComponent;->children:Ljava/util/List;
    ...
    .local v1, "$this$draw_u24lambda_u247_u24lambda_u246_u24lambda_u245":Landroidx/compose/ui/graphics/vector/VNode;
    .local v16, "$this$withTransform$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    invoke-virtual {v1, v0}, Landroidx/compose/ui/graphics/vector/VNode;->draw(Landroidx/compose/ui/graphics/drawscope/DrawScope;)V

    .line 619
    nop

    .line 617
    .end local v1    # "$this$draw_u24lambda_u247_u24lambda_u246_u24lambda_u245":Landroidx/compose/ui/graphics/vector/VNode;
    ...
    .line 662
    .end local v2    # "$this$draw_u24lambda_u247":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v8    # "$i$a$-withTransform-GroupComponent$draw$2":I
    nop
