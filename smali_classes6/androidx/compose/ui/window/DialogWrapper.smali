...
.method public constructor <init>(Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/window/DialogProperties;Landroid/view/View;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/unit/Density;Ljava/util/UUID;)V
    ...
    .line 292
    :cond_0
    sget v3, Landroidx/compose/ui/R$style;->FloatingDialogWindowTheme:I
    ...
    :cond_1
    :goto_0
    sget v3, Landroidx/compose/ui/R$style;->DialogWindowTheme:I
    ...
    invoke-direct {v0, v1, v3, v2, v4}, Landroidx/activity/ComponentDialog;-><init>(Landroid/content/Context;IILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    iput-object v5, v0, Landroidx/compose/ui/window/DialogWrapper;->composeView:Landroid/view/View;
    ...
    .line 310
    iput v8, v0, Landroidx/compose/ui/window/DialogWrapper;->defaultSoftInputMode:I
    ...
    .line 315
    iget-object v8, v0, Landroidx/compose/ui/window/DialogWrapper;->properties:Landroidx/compose/ui/window/DialogProperties;

    invoke-virtual {v8}, Landroidx/compose/ui/window/DialogProperties;->getDecorFitsSystemWindows()Z

    move-result v8

    invoke-static {v7, v8}, Landroidx/core/view/WindowCompat;->setDecorFitsSystemWindows(Landroid/view/Window;Z)V

    .line 316
    new-instance v8, Landroidx/compose/ui/window/DialogLayout;

    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/window/DialogWrapper;->getContext()Landroid/content/Context;

    move-result-object v9

    invoke-direct {v8, v9, v7}, Landroidx/compose/ui/window/DialogLayout;-><init>(Landroid/content/Context;Landroid/view/Window;)V

    move-object v9, v8

    .local v9, "$this$_init__u24lambda_u241":Landroidx/compose/ui/window/DialogLayout;
    const/4 v10, 0x0

    .line 319
    .local v10, "$i$a$-apply-DialogWrapper$1":I
    ...
    invoke-virtual {v9, v11, v12}, Landroidx/compose/ui/window/DialogLayout;->setTag(ILjava/lang/Object;)V

    .line 321
    invoke-virtual {v9, v3}, Landroidx/compose/ui/window/DialogLayout;->setClipChildren(Z)V
    ...
    .line 323
    .local v11, "$i$a$-with-DialogWrapper$1$1":I
    invoke-interface {v3, v6}, Landroidx/compose/ui/unit/Density;->toPx-0680j_4(F)F

    move-result v6

    invoke-virtual {v9, v6}, Landroidx/compose/ui/window/DialogLayout;->setElevation(F)V

    .line 328
    .end local v3    # "$this$lambda_u241_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    .end local v11    # "$i$a$-with-DialogWrapper$1$1":I
    new-instance v3, Landroidx/compose/ui/window/DialogWrapper$1$2;

    invoke-direct {v3}, Landroidx/compose/ui/window/DialogWrapper$1$2;-><init>()V

    check-cast v3, Landroid/view/ViewOutlineProvider;

    invoke-virtual {v9, v3}, Landroidx/compose/ui/window/DialogLayout;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V

    .line 337
    nop

    .line 316
    .end local v9    # "$this$_init__u24lambda_u241":Landroidx/compose/ui/window/DialogLayout;
    .end local v10    # "$i$a$-apply-DialogWrapper$1":I
    iput-object v8, v0, Landroidx/compose/ui/window/DialogWrapper;->dialogLayout:Landroidx/compose/ui/window/DialogLayout;
    ...
    invoke-static {v4}, Landroidx/compose/ui/window/DialogWrapper;->_init_$disableClipping(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v0, v3}, Landroidx/compose/ui/window/DialogWrapper;->setContentView(Landroid/view/View;)V
    ...
    .line 356
    invoke-static {v8, v3}, Landroidx/savedstate/ViewTreeSavedStateRegistryOwner;->set(Landroid/view/View;Landroidx/savedstate/SavedStateRegistryOwner;)V

    .line 361
    iget-object v3, v0, Landroidx/compose/ui/window/DialogWrapper;->onDismissRequest:Lkotlin/jvm/functions/Function0;

    iget-object v4, v0, Landroidx/compose/ui/window/DialogWrapper;->properties:Landroidx/compose/ui/window/DialogProperties;

    move-object/from16 v6, p4

    invoke-virtual {v0, v3, v4, v6}, Landroidx/compose/ui/window/DialogWrapper;->updateParameters(Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/window/DialogProperties;Landroidx/compose/ui/unit/LayoutDirection;)V
    ...
    invoke-direct {v3, v0}, Landroidx/compose/ui/window/DialogWrapper$2;-><init>(Landroidx/compose/ui/window/DialogWrapper;)V
    ...
    invoke-static/range {v14 .. v19}, Landroidx/activity/OnBackPressedDispatcherKt;->addCallback$default(Landroidx/activity/OnBackPressedDispatcher;Landroidx/lifecycle/LifecycleOwner;ZLkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroidx/activity/OnBackPressedCallback;
    ...
    const-string v4, "Dialog has no window"
