...
.method public final invoke(Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/Modifier;
    ...
    const-string v3, "C45@1739L27,48@1941L491:TextFieldCursor.kt#423gt5"
    ...
    .line 46
    .local v10, "$i$a$-remember-TextFieldCursorKt$cursor$1$cursorAlpha$1":I
    const/4 v12, 0x0
    ...
    invoke-static {v14, v12, v13, v11}, Landroidx/compose/animation/core/AnimatableKt;->Animatable$default(FFILjava/lang/Object;)Landroidx/compose/animation/core/Animatable;

    move-result-object v10

    .line 107
    .end local v10    # "$i$a$-remember-TextFieldCursorKt$cursor$1$cursorAlpha$1":I
    nop
    ...
    .line 47
    .local v2, "cursorAlpha":Landroidx/compose/animation/core/Animatable;
    ...
    .line 111
    .local v7, "$i$f$isUnspecified-8_81llA":I
    ...
    .end local v7    # "$i$f$isUnspecified-8_81llA":I
    :goto_2
    if-nez v3, :cond_3
    ...
    .line 48
    .local v3, "isBrushSpecified":Z
    iget-object v4, v0, Landroidx/compose/foundation/text/TextFieldCursorKt$cursor$1;->$state:Landroidx/compose/foundation/text/TextFieldState;
    ...
    invoke-direct {v7, v2, v11}, Landroidx/compose/foundation/text/TextFieldCursorKt$cursor$1$1;-><init>(Landroidx/compose/animation/core/Animatable;Lkotlin/coroutines/Continuation;)V

    check-cast v7, Lkotlin/jvm/functions/Function2;

    const/16 v8, 0x200

    invoke-static {v4, v6, v7, v1, v8}, Landroidx/compose/runtime/EffectsKt;->LaunchedEffect(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V

    .line 58
    new-instance v4, Landroidx/compose/foundation/text/TextFieldCursorKt$cursor$1$2;

    iget-object v14, v0, Landroidx/compose/foundation/text/TextFieldCursorKt$cursor$1;->$offsetMapping:Landroidx/compose/ui/text/input/OffsetMapping;

    iget-object v15, v0, Landroidx/compose/foundation/text/TextFieldCursorKt$cursor$1;->$value:Landroidx/compose/ui/text/input/TextFieldValue;

    iget-object v6, v0, Landroidx/compose/foundation/text/TextFieldCursorKt$cursor$1;->$state:Landroidx/compose/foundation/text/TextFieldState;

    iget-object v7, v0, Landroidx/compose/foundation/text/TextFieldCursorKt$cursor$1;->$cursorBrush:Landroidx/compose/ui/graphics/Brush;
    ...
    invoke-direct/range {v12 .. v17}, Landroidx/compose/foundation/text/TextFieldCursorKt$cursor$1$2;-><init>(Landroidx/compose/animation/core/Animatable;Landroidx/compose/ui/text/input/OffsetMapping;Landroidx/compose/ui/text/input/TextFieldValue;Landroidx/compose/foundation/text/TextFieldState;Landroidx/compose/ui/graphics/Brush;)V

    check-cast v4, Lkotlin/jvm/functions/Function1;

    move-object/from16 v6, p1

    invoke-static {v6, v4}, Landroidx/compose/ui/draw/DrawModifierKt;->drawWithContent(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;)Landroidx/compose/ui/Modifier;
