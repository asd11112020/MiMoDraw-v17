...
.method public final invoke-MK-Hz9U(J)J
    ...
    invoke-virtual {v7, v5, v6}, Landroidx/compose/foundation/gestures/ScrollingLogic;->singleAxisOffset-MK-Hz9U(J)J

    move-result-wide v8

    invoke-virtual {v7, v8, v9}, Landroidx/compose/foundation/gestures/ScrollingLogic;->reverseIfNeeded-MK-Hz9U(J)J
    ...
    iget-object v9, v0, Landroidx/compose/foundation/gestures/ScrollingLogic$dispatchScroll$performScroll$1;->$this_dispatchScroll:Landroidx/compose/foundation/gestures/ScrollScope;

    invoke-interface {v9, v7}, Landroidx/compose/foundation/gestures/ScrollScope;->scrollBy(F)F

    move-result v9

    invoke-virtual {v8, v9}, Landroidx/compose/foundation/gestures/ScrollingLogic;->toOffset-tuRUvjQ(F)J
