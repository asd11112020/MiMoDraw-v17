...
.method public static final getModeNight(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 44
    .param p0, "$this$ModeNight"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.ModeNight"
    ...
    .local v1, "$this$_get_ModeNight__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-ModeNightKt$ModeNight$1":I
    ...
    .local v16, "$this$_get_ModeNight__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-ModeNightKt$ModeNight$1$1":I
    ...
    .end local v16    # "$this$_get_ModeNight__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_ModeNight__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-ModeNightKt$ModeNight$1":I
    ...
    .line 32
    const v28, 0x41128f5c    # 9.16f

    const/high16 v29, 0x40800000    # 4.0f

    const v30, 0x410d1eb8    # 8.82f

    const v31, 0x4080a3d7    # 4.02f
    ...
    .line 100
    .end local v2    # "$this$_get_ModeNight__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-ModeNightKt$ModeNight$1$1":I
    nop
    ...
    .local v15, "$this$_get_ModeNight__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 41
    .local v22, "$i$a$-materialPath-YwgOQQI$default-ModeNightKt$ModeNight$1$2":I
    ...
    .end local v15    # "$this$_get_ModeNight__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v4, "$this$_get_ModeNight__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v19, 0x409e6666    # 4.95f

    const/high16 v20, 0x40a00000    # 5.0f

    const v21, 0x410a6666    # 8.65f
    ...
    .end local v1    # "$this$_get_ModeNight__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_ModeNight__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    invoke-virtual {v4, v1, v2, v15, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v4, v0, v1, v2, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v4, v0, v1, v15, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 138
    .end local v4    # "$this$_get_ModeNight__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-ModeNightKt$ModeNight$1$2":I
    nop
    ...
    .line 75
    .end local v41    # "$i$a$-materialIcon$default-ModeNightKt$ModeNight$1":I
    .end local v42    # "$this$_get_ModeNight__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
