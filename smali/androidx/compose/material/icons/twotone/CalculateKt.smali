...
.method public static final getCalculate(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$Calculate"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.Calculate"
    ...
    .local v1, "$this$_get_Calculate__u24lambda_u247":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v27, "$this$_get_Calculate__u24lambda_u247_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-CalculateKt$Calculate$1$1":I
    ...
    .end local v27    # "$this$_get_Calculate__u24lambda_u247_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_Calculate__u24lambda_u247_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 195
    .end local v0    # "$this$_get_Calculate__u24lambda_u247_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-CalculateKt$Calculate$1$1":I
    nop
    ...
    .local v12, "$this$_get_Calculate__u24lambda_u247_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 85
    .local v22, "$i$a$-materialPath-YwgOQQI$default-CalculateKt$Calculate$1$2":I
    ...
    .line 233
    .end local v12    # "$this$_get_Calculate__u24lambda_u247_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-CalculateKt$Calculate$1$2":I
    nop
    ...
    .local v12, "$this$_get_Calculate__u24lambda_u247_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v15, 0x0

    .line 103
    .local v15, "$i$a$-materialPath-YwgOQQI$default-CalculateKt$Calculate$1$3":I
    ...
    .line 271
    .end local v12    # "$this$_get_Calculate__u24lambda_u247_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v15    # "$i$a$-materialPath-YwgOQQI$default-CalculateKt$Calculate$1$3":I
    nop
    ...
    .local v11, "$this$_get_Calculate__u24lambda_u247_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0
    ...
    .line 309
    .end local v11    # "$this$_get_Calculate__u24lambda_u247_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v11, "$this$_get_Calculate__u24lambda_u247_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0
    ...
    .line 347
    .end local v11    # "$this$_get_Calculate__u24lambda_u247_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v11, "$this$_get_Calculate__u24lambda_u247_u24lambda_u245":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0
    ...
    .line 385
    .end local v11    # "$this$_get_Calculate__u24lambda_u247_u24lambda_u245":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v11, "$this$_get_Calculate__u24lambda_u247_u24lambda_u246":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 139
    .local v12, "$i$a$-materialPath-YwgOQQI$default-CalculateKt$Calculate$1$7":I
    ...
    .line 423
    .end local v11    # "$this$_get_Calculate__u24lambda_u247_u24lambda_u246":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-CalculateKt$Calculate$1$7":I
    nop
    ...
    .line 170
    .end local v1    # "$this$_get_Calculate__u24lambda_u247":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
