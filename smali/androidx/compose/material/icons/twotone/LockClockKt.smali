...
.method public static final getLockClock(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$LockClock"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.LockClock"
    ...
    .local v1, "$this$_get_LockClock__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-LockClockKt$LockClock$1":I
    move-object v3, v1
    ...
    .local v35, "$this$_get_LockClock__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-LockClockKt$LockClock$1$1":I
    ...
    .end local v35    # "$this$_get_LockClock__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_LockClock__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-LockClockKt$LockClock$1":I
    .local v42, "$i$a$-materialIcon$default-LockClockKt$LockClock$1":I
    invoke-virtual {v0, v11, v8, v11, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v30, 0x41ab3333    # 21.4f

    const v31, 0x413828f6    # 11.51f

    const v32, 0x41a5c28f    # 20.72f

    const v33, 0x4134a3d7    # 11.29f
    ...
    .line 127
    .end local v0    # "$this$_get_LockClock__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-LockClockKt$LockClock$1$1":I
    nop
    ...
    .local v10, "$this$_get_LockClock__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v11, 0x0

    .line 60
    .local v11, "$i$a$-materialPath-YwgOQQI$default-LockClockKt$LockClock$1$2":I
    ...
    const v17, 0x419af5c3    # 19.37f

    const/high16 v18, 0x41300000    # 11.0f

    const v19, 0x4195999a    # 18.7f
    ...
    .line 165
    .end local v10    # "$this$_get_LockClock__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v11    # "$i$a$-materialPath-YwgOQQI$default-LockClockKt$LockClock$1$2":I
    nop
    ...
    .local v11, "$this$_get_LockClock__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 70
    .local v22, "$i$a$-materialPath-YwgOQQI$default-LockClockKt$LockClock$1$3":I
    ...
    invoke-virtual {v11, v0, v15, v0, v12}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v11, v0, v12, v15, v12}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v11, v0, v12}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 82
    invoke-virtual {v11, v0, v12}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 203
    .end local v11    # "$this$_get_LockClock__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-LockClockKt$LockClock$1$3":I
    nop
    ...
    .line 102
    .end local v1    # "$this$_get_LockClock__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v42    # "$i$a$-materialIcon$default-LockClockKt$LockClock$1":I
