...
.method public static final getSaveAs(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$SaveAs"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.SaveAs"
    ...
    .local v1, "$this$_get_SaveAs__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SaveAsKt$SaveAs$1":I
    ...
    .local v16, "$this$_get_SaveAs__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SaveAsKt$SaveAs$1$1":I
    ...
    .end local v16    # "$this$_get_SaveAs__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_SaveAs__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-SaveAsKt$SaveAs$1":I
    ...
    .line 139
    .end local v2    # "$this$_get_SaveAs__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SaveAsKt$SaveAs$1$1":I
    nop
    ...
    .local v15, "$this$_get_SaveAs__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 53
    .local v22, "$i$a$-materialPath-YwgOQQI$default-SaveAsKt$SaveAs$1$2":I
    ...
    .end local v15    # "$this$_get_SaveAs__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SaveAs__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_SaveAs__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_SaveAs__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    invoke-virtual {v0, v10, v1, v10, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 94
    const v16, 0x41bb999a    # 23.45f

    const/high16 v17, 0x41800000    # 16.0f

    const v18, 0x41bb999a    # 23.45f

    const v19, 0x41828f5c    # 16.32f

    const/high16 v20, 0x41ba0000    # 23.25f
    ...
    .line 177
    .end local v0    # "$this$_get_SaveAs__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-SaveAsKt$SaveAs$1$2":I
    nop
    ...
    .line 114
    .end local v41    # "$i$a$-materialIcon$default-SaveAsKt$SaveAs$1":I
    .end local v42    # "$this$_get_SaveAs__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
