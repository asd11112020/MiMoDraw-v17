...
.method public static final getCarCrash(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 44
    .param p0, "$this$CarCrash"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.CarCrash"
    ...
    .local v1, "$this$_get_CarCrash__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-CarCrashKt$CarCrash$1":I
    ...
    .local v34, "$this$_get_CarCrash__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-CarCrashKt$CarCrash$1$1":I
    ...
    .end local v34    # "$this$_get_CarCrash__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_CarCrash__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-CarCrashKt$CarCrash$1":I
    .local v41, "$i$a$-materialIcon$default-CarCrashKt$CarCrash$1":I
    ...
    const v30, 0x41931eb8    # 18.39f

    const/high16 v31, 0x41500000    # 13.0f

    const v32, 0x418f47ae    # 17.91f
    ...
    .line 153
    .end local v0    # "$this$_get_CarCrash__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-CarCrashKt$CarCrash$1$1":I
    nop
    ...
    .local v12, "$this$_get_CarCrash__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 51
    .local v22, "$i$a$-materialPath-YwgOQQI$default-CarCrashKt$CarCrash$1$2":I
    ...
    invoke-virtual {v12, v15, v10, v10, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v12, v10, v15, v10, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v12, v0, v15, v10, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v12, v10, v15, v10, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v12, v10, v0, v15, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v12, v10, v0, v10, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v12, v10, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_CarCrash__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_CarCrash__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const v1, -0x40d47ae1    # -0.67f

    invoke-virtual {v12, v15, v1, v0, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 108
    const/high16 v16, 0x41900000    # 18.0f

    const v17, 0x41551eb8    # 13.32f

    const v18, 0x418fc28f    # 17.97f

    const v19, 0x41528f5c    # 13.16f

    const v20, 0x418f47ae    # 17.91f
    ...
    .line 191
    .end local v12    # "$this$_get_CarCrash__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-CarCrashKt$CarCrash$1$2":I
    nop
    ...
    .line 128
    .end local v41    # "$i$a$-materialIcon$default-CarCrashKt$CarCrash$1":I
    .end local v42    # "$this$_get_CarCrash__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
