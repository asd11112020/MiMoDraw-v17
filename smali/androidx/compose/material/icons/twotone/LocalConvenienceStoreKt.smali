...
.method public static final getLocalConvenienceStore(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 41
    .param p0, "$this$LocalConvenienceStore"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.LocalConvenienceStore"
    ...
    .local v1, "$this$_get_LocalConvenienceStore__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v27, "$this$_get_LocalConvenienceStore__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-LocalConvenienceStoreKt$LocalConvenienceStore$1$1":I
    const/high16 v10, 0x41600000    # 14.0f

    move-object/from16 v7, v27

    .end local v27    # "$this$_get_LocalConvenienceStore__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v7, "$this$_get_LocalConvenienceStore__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 170
    .end local v7    # "$this$_get_LocalConvenienceStore__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-LocalConvenienceStoreKt$LocalConvenienceStore$1$1":I
    nop
    ...
    .local v12, "$this$_get_LocalConvenienceStore__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v15, 0x0

    .line 74
    .local v15, "$i$a$-materialPath-YwgOQQI$default-LocalConvenienceStoreKt$LocalConvenienceStore$1$2":I
    ...
    .end local v1    # "$this$_get_LocalConvenienceStore__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v17, "$this$_get_LocalConvenienceStore__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 208
    .end local v12    # "$this$_get_LocalConvenienceStore__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v15    # "$i$a$-materialPath-YwgOQQI$default-LocalConvenienceStoreKt$LocalConvenienceStore$1$2":I
    nop
    ...
    .line 145
    .end local v2    # "$i$a$-materialIcon$default-LocalConvenienceStoreKt$LocalConvenienceStore$1":I
    .end local v17    # "$this$_get_LocalConvenienceStore__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
