...
.method public static final getRemoveFromQueue(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$RemoveFromQueue"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.RemoveFromQueue"
    ...
    .local v1, "$this$_get_RemoveFromQueue__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-RemoveFromQueueKt$RemoveFromQueue$1":I
    ...
    .local v16, "$this$_get_RemoveFromQueue__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v27, 0x0

    .line 31
    .local v27, "$i$a$-materialPath-YwgOQQI$default-RemoveFromQueueKt$RemoveFromQueue$1$1":I
    ...
    .end local v16    # "$this$_get_RemoveFromQueue__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_RemoveFromQueue__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-RemoveFromQueueKt$RemoveFromQueue$1":I
    ...
    .line 113
    .end local v2    # "$this$_get_RemoveFromQueue__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v27    # "$i$a$-materialPath-YwgOQQI$default-RemoveFromQueueKt$RemoveFromQueue$1$1":I
    nop
    ...
    .local v15, "$this$_get_RemoveFromQueue__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 45
    .local v22, "$i$a$-materialPath-YwgOQQI$default-RemoveFromQueueKt$RemoveFromQueue$1$2":I
    const/high16 v0, 0x41a80000    # 21.0f
    ...
    .end local v15    # "$this$_get_RemoveFromQueue__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_RemoveFromQueue__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 151
    .end local v0    # "$this$_get_RemoveFromQueue__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-RemoveFromQueueKt$RemoveFromQueue$1$2":I
    nop
    ...
    .line 88
    .end local v1    # "$this$_get_RemoveFromQueue__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-RemoveFromQueueKt$RemoveFromQueue$1":I
