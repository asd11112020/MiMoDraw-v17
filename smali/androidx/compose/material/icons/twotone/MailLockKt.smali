...
.method public static final getMailLock(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.MailLock"
    ...
    .line 30
    .local v2, "$i$a$-materialIcon$default-MailLockKt$MailLock$1":I
    ...
    .local v27, "$this$_get_MailLock__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-MailLockKt$MailLock$1$1":I
    ...
    .end local v27    # "$this$_get_MailLock__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_MailLock__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 136
    .end local v0    # "$this$_get_MailLock__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-MailLockKt$MailLock$1$1":I
    nop
    ...
    .local v15, "$this$_get_MailLock__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 37
    .local v22, "$i$a$-materialPath-YwgOQQI$default-MailLockKt$MailLock$1$2":I
    ...
    .end local v15    # "$this$_get_MailLock__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_MailLock__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v10, v7, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 174
    .end local v10    # "$this$_get_MailLock__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-MailLockKt$MailLock$1$2":I
    nop
    ...
    .local v12, "$this$_get_MailLock__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v15, 0x0

    .line 48
    .local v15, "$i$a$-materialPath-YwgOQQI$default-MailLockKt$MailLock$1$3":I
    ...
    .end local v2    # "$i$a$-materialIcon$default-MailLockKt$MailLock$1":I
    .local v18, "$i$a$-materialIcon$default-MailLockKt$MailLock$1":I
    ...
    .line 58
    const v46, 0x4039999a    # 2.9f

    const/high16 v47, 0x40800000    # 4.0f

    const v48, 0x4000a3d7    # 2.01f

    const v49, 0x409ccccd    # 4.9f

    const v50, 0x4000a3d7    # 2.01f
    ...
    .line 212
    .end local v12    # "$this$_get_MailLock__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v15    # "$i$a$-materialPath-YwgOQQI$default-MailLockKt$MailLock$1$3":I
    nop
    ...
    .local v11, "$this$_get_MailLock__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 72
    .local v12, "$i$a$-materialPath-YwgOQQI$default-MailLockKt$MailLock$1$4":I
    ...
    .local v16, "$this$_get_MailLock__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    const v43, 0x41773333    # 15.45f

    const v44, 0x41bc6666    # 23.55f
    ...
    .line 250
    .end local v11    # "$this$_get_MailLock__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-MailLockKt$MailLock$1$4":I
    nop
    ...
    .line 111
    .end local v16    # "$this$_get_MailLock__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v18    # "$i$a$-materialIcon$default-MailLockKt$MailLock$1":I
