...
.method public static final getSendToMobile(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$SendToMobile"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 35
    :cond_0
    const-string/jumbo v0, "TwoTone.SendToMobile"
    ...
    .local v1, "$this$_get_SendToMobile__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 36
    .local v2, "$i$a$-materialIcon$default-SendToMobileKt$SendToMobile$1":I
    ...
    .local v27, "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 37
    .local v28, "$i$a$-materialPath-YwgOQQI$default-SendToMobileKt$SendToMobile$1$1":I
    ...
    .end local v27    # "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 133
    .end local v0    # "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-SendToMobileKt$SendToMobile$1$1":I
    nop
    ...
    .local v15, "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v16, 0x0

    .line 44
    .local v16, "$i$a$-materialPath-YwgOQQI$default-SendToMobileKt$SendToMobile$1$2":I
    ...
    .line 171
    .end local v15    # "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v16    # "$i$a$-materialPath-YwgOQQI$default-SendToMobileKt$SendToMobile$1$2":I
    nop
    ...
    .local v15, "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 51
    .local v22, "$i$a$-materialPath-YwgOQQI$default-SendToMobileKt$SendToMobile$1$3":I
    ...
    .end local v15    # "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 209
    .end local v0    # "$this$_get_SendToMobile__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-SendToMobileKt$SendToMobile$1$3":I
    nop
    ...
    .line 108
    .end local v1    # "$this$_get_SendToMobile__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v2    # "$i$a$-materialIcon$default-SendToMobileKt$SendToMobile$1":I
