...
.method public static final getAdfScanner(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.AdfScanner"
    ...
    .line 30
    .local v2, "$i$a$-materialIcon$default-AdfScannerKt$AdfScanner$1":I
    ...
    .local v27, "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-AdfScannerKt$AdfScanner$1$1":I
    ...
    .end local v27    # "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 129
    .end local v0    # "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-AdfScannerKt$AdfScanner$1$1":I
    nop
    ...
    .local v12, "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 38
    .local v22, "$i$a$-materialPath-YwgOQQI$default-AdfScannerKt$AdfScanner$1$2":I
    ...
    .line 167
    .end local v12    # "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-AdfScannerKt$AdfScanner$1$2":I
    nop
    ...
    .local v12, "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 54
    .local v22, "$i$a$-materialPath-YwgOQQI$default-AdfScannerKt$AdfScanner$1$3":I
    ...
    .line 205
    .end local v12    # "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-AdfScannerKt$AdfScanner$1$3":I
    nop
    ...
    .local v12, "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v24, 0x0

    .line 82
    .local v24, "$i$a$-materialPath-YwgOQQI$default-AdfScannerKt$AdfScanner$1$4":I
    ...
    .line 243
    .end local v12    # "$this$_get_AdfScanner__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v24    # "$i$a$-materialPath-YwgOQQI$default-AdfScannerKt$AdfScanner$1$4":I
    nop
    ...
    .end local v2    # "$i$a$-materialIcon$default-AdfScannerKt$AdfScanner$1":I
