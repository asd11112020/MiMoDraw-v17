...
.method public static final getSafetyCheck(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$SafetyCheck"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.SafetyCheck"
    ...
    .local v1, "$this$_get_SafetyCheck__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SafetyCheckKt$SafetyCheck$1":I
    ...
    .local v34, "$this$_get_SafetyCheck__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SafetyCheckKt$SafetyCheck$1$1":I
    ...
    .end local v34    # "$this$_get_SafetyCheck__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SafetyCheck__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-SafetyCheckKt$SafetyCheck$1":I
    .local v41, "$i$a$-materialIcon$default-SafetyCheckKt$SafetyCheck$1":I
    ...
    .line 128
    .end local v0    # "$this$_get_SafetyCheck__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SafetyCheckKt$SafetyCheck$1$1":I
    nop
    ...
    .local v24, "$this$_get_SafetyCheck__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 55
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SafetyCheckKt$SafetyCheck$1$2":I
    ...
    .end local v24    # "$this$_get_SafetyCheck__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_SafetyCheck__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v18, 0x40a1999a    # 5.05f

    const v19, 0x405a3d71    # 3.41f

    const v20, 0x411c28f6    # 9.76f

    const/high16 v21, 0x41000000    # 8.0f

    const v22, 0x412e8f5c    # 10.91f
    ...
    const v20, -0x3f447ae1    # -5.86f

    const v22, -0x3ed170a4    # -10.91f
    ...
    const v20, -0x3f65c28f    # -4.82f

    const v22, -0x3ef2b852    # -8.83f
    ...
    invoke-virtual {v2, v10, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v10, v7, v7, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v7, v10, v7, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v0, v7, v10, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v7, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 166
    .end local v2    # "$this$_get_SafetyCheck__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SafetyCheckKt$SafetyCheck$1$2":I
    nop
    ...
    .line 103
    .end local v1    # "$this$_get_SafetyCheck__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-SafetyCheckKt$SafetyCheck$1":I
