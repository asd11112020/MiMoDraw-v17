...
.method public static final getRecordVoiceOver(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.RecordVoiceOver"
    ...
    .line 30
    .local v2, "$i$a$-materialIcon$default-RecordVoiceOverKt$RecordVoiceOver$1":I
    ...
    .local v35, "$this$_get_RecordVoiceOver__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-RecordVoiceOverKt$RecordVoiceOver$1$1":I
    const/high16 v7, 0x41100000    # 9.0f

    move-object/from16 v10, v35

    .end local v35    # "$this$_get_RecordVoiceOver__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_RecordVoiceOver__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 123
    .end local v10    # "$this$_get_RecordVoiceOver__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-RecordVoiceOverKt$RecordVoiceOver$1$1":I
    nop
    ...
    .local v12, "$this$_get_RecordVoiceOver__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 37
    .local v22, "$i$a$-materialPath-YwgOQQI$default-RecordVoiceOverKt$RecordVoiceOver$1$2":I
    ...
    .line 161
    .end local v12    # "$this$_get_RecordVoiceOver__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-RecordVoiceOverKt$RecordVoiceOver$1$2":I
    nop
    ...
    .local v12, "$this$_get_RecordVoiceOver__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 44
    .local v22, "$i$a$-materialPath-YwgOQQI$default-RecordVoiceOverKt$RecordVoiceOver$1$3":I
    ...
    .local v41, "$this$_get_RecordVoiceOver__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    const v19, -0x3ee0cccd    # -9.95f

    const/high16 v21, -0x3ea00000    # -14.0f
    ...
    .line 199
    .end local v12    # "$this$_get_RecordVoiceOver__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-RecordVoiceOverKt$RecordVoiceOver$1$3":I
    nop
    ...
    .line 98
    .end local v2    # "$i$a$-materialIcon$default-RecordVoiceOverKt$RecordVoiceOver$1":I
    .end local v41    # "$this$_get_RecordVoiceOver__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
