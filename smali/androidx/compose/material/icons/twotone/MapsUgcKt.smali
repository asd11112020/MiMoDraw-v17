...
.method public static final getMapsUgc(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$MapsUgc"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 30
    :cond_0
    const-string/jumbo v0, "TwoTone.MapsUgc"
    ...
    .local v1, "$this$_get_MapsUgc__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 31
    .local v2, "$i$a$-materialIcon$default-MapsUgcKt$MapsUgc$1":I
    ...
    .local v34, "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 32
    .local v35, "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$1":I
    ...
    .end local v34    # "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-MapsUgcKt$MapsUgc$1":I
    .local v41, "$i$a$-materialIcon$default-MapsUgcKt$MapsUgc$1":I
    ...
    .line 124
    .end local v0    # "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$1":I
    nop
    ...
    .local v24, "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 45
    .local v35, "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$2":I
    ...
    .end local v24    # "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v10, v0, v7, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v7, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 61
    const v17, 0x411051ec    # 9.02f
    ...
    .line 162
    .end local v2    # "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$2":I
    nop
    ...
    .local v11, "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 68
    .local v12, "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$3":I
    ...
    .line 200
    .end local v11    # "$this$_get_MapsUgc__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$3":I
    nop
    ...
    .line 99
    .end local v1    # "$this$_get_MapsUgc__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-MapsUgcKt$MapsUgc$1":I
