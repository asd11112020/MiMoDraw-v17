...
.method public static final getNotificationImportant(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$NotificationImportant"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.NotificationImportant"
    ...
    .local v1, "$this$_get_NotificationImportant__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-NotificationImportantKt$NotificationImportant$1":I
    ...
    .local v34, "$this$_get_NotificationImportant__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-NotificationImportantKt$NotificationImportant$1$1":I
    ...
    .end local v34    # "$this$_get_NotificationImportant__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_NotificationImportant__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 132
    .end local v0    # "$this$_get_NotificationImportant__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-NotificationImportantKt$NotificationImportant$1$1":I
    nop
    ...
    .local v24, "$this$_get_NotificationImportant__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 52
    .local v35, "$i$a$-materialPath-YwgOQQI$default-NotificationImportantKt$NotificationImportant$1$2":I
    ...
    .end local v24    # "$this$_get_NotificationImportant__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_NotificationImportant__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v20, -0x3f3b3333    # -6.15f

    const/high16 v21, -0x3f500000    # -5.5f

    const v22, -0x3f2570a4    # -6.83f
    ...
    .end local v1    # "$this$_get_NotificationImportant__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_NotificationImportant__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/high16 v1, -0x40400000    # -1.5f

    invoke-virtual {v10, v1, v0, v1, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v10, v1, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 170
    .end local v10    # "$this$_get_NotificationImportant__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-NotificationImportantKt$NotificationImportant$1$2":I
    nop
    ...
    .line 107
    .end local v2    # "$i$a$-materialIcon$default-NotificationImportantKt$NotificationImportant$1":I
    .end local v42    # "$this$_get_NotificationImportant__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
