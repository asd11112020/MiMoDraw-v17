...
.method public static final getMicNone(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$MicNone"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.MicNone"
    ...
    .local v1, "$this$_get_MicNone__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-MicNoneKt$MicNone$1":I
    ...
    .local v34, "$this$_get_MicNone__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-MicNoneKt$MicNone$1$1":I
    const/high16 v10, 0x41400000    # 12.0f

    move-object/from16 v7, v34

    .end local v34    # "$this$_get_MicNone__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v7, "$this$_get_MicNone__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-MicNoneKt$MicNone$1":I
    .local v41, "$i$a$-materialIcon$default-MicNoneKt$MicNone$1":I
    invoke-virtual {v7, v10, v0, v10, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 111
    .end local v7    # "$this$_get_MicNone__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-MicNoneKt$MicNone$1$1":I
    nop
    ...
    .local v24, "$this$_get_MicNone__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 41
    .local v35, "$i$a$-materialPath-YwgOQQI$default-MicNoneKt$MicNone$1$2":I
    ...
    .end local v24    # "$this$_get_MicNone__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_MicNone__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_MicNone__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_MicNone__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    invoke-virtual {v0, v10, v2, v10, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 149
    .end local v0    # "$this$_get_MicNone__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-MicNoneKt$MicNone$1$2":I
    nop
    ...
    .line 86
    .end local v41    # "$i$a$-materialIcon$default-MicNoneKt$MicNone$1":I
    .end local v42    # "$this$_get_MicNone__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
