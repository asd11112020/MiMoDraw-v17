...
.method public static final getOutbox(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$Outbox"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.Outbox"
    ...
    .local v1, "$this$_get_Outbox__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-OutboxKt$Outbox$1":I
    ...
    .local v34, "$this$_get_Outbox__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$1":I
    ...
    .end local v34    # "$this$_get_Outbox__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_Outbox__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 123
    .end local v0    # "$this$_get_Outbox__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$1":I
    nop
    ...
    .local v15, "$this$_get_Outbox__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v16, 0x0

    .line 42
    .local v16, "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$2":I
    ...
    .line 161
    .end local v15    # "$this$_get_Outbox__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v16    # "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$2":I
    nop
    ...
    .local v12, "$this$_get_Outbox__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v15, 0x0

    .line 52
    .local v15, "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$3":I
    ...
    .end local v1    # "$this$_get_Outbox__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v17, "$this$_get_Outbox__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 66
    const v36, 0x3f68f5c3    # 0.91f

    const v37, 0x3f9ae148    # 1.21f

    const v38, 0x40166666    # 2.35f

    const/high16 v39, 0x40000000    # 2.0f

    const v40, 0x407eb852    # 3.98f
    ...
    .end local v2    # "$i$a$-materialIcon$default-OutboxKt$Outbox$1":I
    .local v20, "$i$a$-materialIcon$default-OutboxKt$Outbox$1":I
    ...
    invoke-virtual {v12, v2, v1, v0, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v37, 0x3f947ae1    # 1.16f

    const v38, -0x403eb852    # -1.51f

    const v40, -0x3fcb851f    # -2.82f
    ...
    .line 199
    .end local v12    # "$this$_get_Outbox__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v15    # "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$3":I
    nop
    ...
    .line 98
    .end local v17    # "$this$_get_Outbox__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v20    # "$i$a$-materialIcon$default-OutboxKt$Outbox$1":I
