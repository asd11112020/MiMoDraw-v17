...
.method public static final getBackupTable(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 49
    .param p0, "$this$BackupTable"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.BackupTable"
    ...
    .local v1, "$this$_get_BackupTable__u24lambda_u245":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-BackupTableKt$BackupTable$1":I
    ...
    .local v27, "$this$_get_BackupTable__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$1":I
    const/high16 v7, 0x41300000    # 11.0f

    move-object/from16 v10, v27

    .end local v27    # "$this$_get_BackupTable__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_BackupTable__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 134
    .end local v10    # "$this$_get_BackupTable__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$1":I
    nop
    ...
    .local v15, "$this$_get_BackupTable__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v16, 0x0

    .line 38
    .local v16, "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$2":I
    ...
    .line 172
    .end local v15    # "$this$_get_BackupTable__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v16    # "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$2":I
    nop
    ...
    .local v12, "$this$_get_BackupTable__u24lambda_u245_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v15, 0x0

    .line 45
    .local v15, "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$3":I
    ...
    .line 210
    .end local v12    # "$this$_get_BackupTable__u24lambda_u245_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v15    # "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$3":I
    nop
    ...
    .local v12, "$this$_get_BackupTable__u24lambda_u245_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v15, 0x0

    .line 52
    .local v15, "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$4":I
    ...
    .end local v2    # "$i$a$-materialIcon$default-BackupTableKt$BackupTable$1":I
    .local v21, "$i$a$-materialIcon$default-BackupTableKt$BackupTable$1":I
    ...
    .line 248
    .end local v12    # "$this$_get_BackupTable__u24lambda_u245_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v15    # "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$4":I
    nop
    ...
    .local v11, "$this$_get_BackupTable__u24lambda_u245_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 63
    .local v12, "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$5":I
    ...
    .line 286
    .end local v11    # "$this$_get_BackupTable__u24lambda_u245_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-BackupTableKt$BackupTable$1$5":I
    nop
    ...
    .line 109
    .end local v1    # "$this$_get_BackupTable__u24lambda_u245":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v21    # "$i$a$-materialIcon$default-BackupTableKt$BackupTable$1":I
