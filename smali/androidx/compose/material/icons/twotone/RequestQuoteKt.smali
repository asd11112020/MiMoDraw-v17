...
.method public static final getRequestQuote(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$RequestQuote"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.RequestQuote"
    ...
    .local v1, "$this$_get_RequestQuote__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-RequestQuoteKt$RequestQuote$1":I
    ...
    .local v34, "$this$_get_RequestQuote__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-RequestQuoteKt$RequestQuote$1$1":I
    ...
    .end local v34    # "$this$_get_RequestQuote__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_RequestQuote__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 154
    .end local v0    # "$this$_get_RequestQuote__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-RequestQuoteKt$RequestQuote$1$1":I
    nop
    ...
    .local v15, "$this$_get_RequestQuote__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 67
    .local v22, "$i$a$-materialPath-YwgOQQI$default-RequestQuoteKt$RequestQuote$1$2":I
    ...
    .end local v15    # "$this$_get_RequestQuote__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_RequestQuote__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 192
    .end local v0    # "$this$_get_RequestQuote__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-RequestQuoteKt$RequestQuote$1$2":I
    nop
    ...
    .line 129
    .end local v1    # "$this$_get_RequestQuote__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v2    # "$i$a$-materialIcon$default-RequestQuoteKt$RequestQuote$1":I
