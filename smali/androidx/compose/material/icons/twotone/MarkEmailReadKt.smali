...
.method public static final getMarkEmailRead(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$MarkEmailRead"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.MarkEmailRead"
    ...
    .local v1, "$this$_get_MarkEmailRead__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-MarkEmailReadKt$MarkEmailRead$1":I
    ...
    .local v16, "$this$_get_MarkEmailRead__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-MarkEmailReadKt$MarkEmailRead$1$1":I
    ...
    .end local v16    # "$this$_get_MarkEmailRead__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_MarkEmailRead__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-MarkEmailReadKt$MarkEmailRead$1":I
    ...
    const v30, -0x3f323d71    # -6.43f

    const v31, 0x40270a3d    # 2.61f

    const v32, -0x3f228f5c    # -6.92f
    ...
    .line 120
    .end local v2    # "$this$_get_MarkEmailRead__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-MarkEmailReadKt$MarkEmailRead$1$1":I
    nop
    ...
    .local v11, "$this$_get_MarkEmailRead__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 47
    .local v12, "$i$a$-materialPath-YwgOQQI$default-MarkEmailReadKt$MarkEmailRead$1$2":I
    ...
    .end local v1    # "$this$_get_MarkEmailRead__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_MarkEmailRead__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    move-object v15, v11
    ...
    invoke-virtual {v11, v0, v15, v1, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 158
    .end local v11    # "$this$_get_MarkEmailRead__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-MarkEmailReadKt$MarkEmailRead$1$2":I
    nop
    ...
    .line 95
    .end local v41    # "$i$a$-materialIcon$default-MarkEmailReadKt$MarkEmailRead$1":I
    .end local v42    # "$this$_get_MarkEmailRead__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
