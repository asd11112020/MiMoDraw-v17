...
.method public static final getLocalTaxi(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$LocalTaxi"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.LocalTaxi"
    ...
    .local v1, "$this$_get_LocalTaxi__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-LocalTaxiKt$LocalTaxi$1":I
    ...
    .local v34, "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-LocalTaxiKt$LocalTaxi$1$1":I
    ...
    .end local v34    # "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-LocalTaxiKt$LocalTaxi$1":I
    .local v42, "$i$a$-materialIcon$default-LocalTaxiKt$LocalTaxi$1":I
    ...
    .line 144
    .end local v0    # "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-LocalTaxiKt$LocalTaxi$1$1":I
    nop
    ...
    .local v12, "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 53
    .local v22, "$i$a$-materialPath-YwgOQQI$default-LocalTaxiKt$LocalTaxi$1$2":I
    ...
    .line 182
    .end local v12    # "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-LocalTaxiKt$LocalTaxi$1$2":I
    nop
    ...
    .local v11, "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 91
    .local v12, "$i$a$-materialPath-YwgOQQI$default-LocalTaxiKt$LocalTaxi$1$3":I
    ...
    .line 220
    .end local v11    # "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-LocalTaxiKt$LocalTaxi$1$3":I
    nop
    ...
    .local v12, "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v24, 0x0

    .line 97
    .local v24, "$i$a$-materialPath-YwgOQQI$default-LocalTaxiKt$LocalTaxi$1$4":I
    ...
    .line 258
    .end local v12    # "$this$_get_LocalTaxi__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v24    # "$i$a$-materialPath-YwgOQQI$default-LocalTaxiKt$LocalTaxi$1$4":I
    nop
    ...
    .line 119
    .end local v1    # "$this$_get_LocalTaxi__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v42    # "$i$a$-materialIcon$default-LocalTaxiKt$LocalTaxi$1":I
