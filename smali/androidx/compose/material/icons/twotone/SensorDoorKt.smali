...
.method public static final getSensorDoor(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$SensorDoor"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.SensorDoor"
    ...
    .local v1, "$this$_get_SensorDoor__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SensorDoorKt$SensorDoor$1":I
    ...
    .local v16, "$this$_get_SensorDoor__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SensorDoorKt$SensorDoor$1$1":I
    ...
    .end local v16    # "$this$_get_SensorDoor__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_SensorDoor__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-SensorDoorKt$SensorDoor$1":I
    ...
    .line 107
    .end local v2    # "$this$_get_SensorDoor__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SensorDoorKt$SensorDoor$1$1":I
    nop
    ...
    .local v12, "$this$_get_SensorDoor__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 44
    .local v22, "$i$a$-materialPath-YwgOQQI$default-SensorDoorKt$SensorDoor$1$2":I
    ...
    .end local v1    # "$this$_get_SensorDoor__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v16, "$this$_get_SensorDoor__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 145
    .end local v12    # "$this$_get_SensorDoor__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-SensorDoorKt$SensorDoor$1$2":I
    nop
    ...
    .line 82
    .end local v16    # "$this$_get_SensorDoor__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-SensorDoorKt$SensorDoor$1":I
