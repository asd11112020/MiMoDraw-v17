...
.method public static final getContactPhone(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 44
    .param p0, "$this$ContactPhone"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.ContactPhone"
    ...
    .local v1, "$this$_get_ContactPhone__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-ContactPhoneKt$ContactPhone$1":I
    ...
    .local v34, "$this$_get_ContactPhone__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0
    ...
    .end local v34    # "$this$_get_ContactPhone__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_ContactPhone__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-ContactPhoneKt$ContactPhone$1":I
    .local v43, "$i$a$-materialIcon$default-ContactPhoneKt$ContactPhone$1":I
    ...
    invoke-virtual {v0, v2, v10, v7, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v3, v7, v10, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 163
    .end local v0    # "$this$_get_ContactPhone__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v11, "$this$_get_ContactPhone__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 66
    .local v12, "$i$a$-materialPath-YwgOQQI$default-ContactPhoneKt$ContactPhone$1$2":I
    ...
    .end local v1    # "$this$_get_ContactPhone__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v41, "$this$_get_ContactPhone__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 201
    .end local v11    # "$this$_get_ContactPhone__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-ContactPhoneKt$ContactPhone$1$2":I
    nop
    ...
    .line 138
    .end local v41    # "$this$_get_ContactPhone__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v43    # "$i$a$-materialIcon$default-ContactPhoneKt$ContactPhone$1":I
