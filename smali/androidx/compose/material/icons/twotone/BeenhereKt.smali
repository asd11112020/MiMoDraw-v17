...
.method public static final getBeenhere(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$Beenhere"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.Beenhere"
    ...
    .local v1, "$this$_get_Beenhere__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-BeenhereKt$Beenhere$1":I
    ...
    .local v27, "$this$_get_Beenhere__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-BeenhereKt$Beenhere$1$1":I
    ...
    .end local v27    # "$this$_get_Beenhere__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_Beenhere__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 116
    .end local v0    # "$this$_get_Beenhere__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-BeenhereKt$Beenhere$1$1":I
    nop
    ...
    .local v24, "$this$_get_Beenhere__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v41, 0x0

    .line 48
    .local v41, "$i$a$-materialPath-YwgOQQI$default-BeenhereKt$Beenhere$1$2":I
    ...
    .end local v24    # "$this$_get_Beenhere__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v7, "$this$_get_Beenhere__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 154
    .end local v7    # "$this$_get_Beenhere__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v41    # "$i$a$-materialPath-YwgOQQI$default-BeenhereKt$Beenhere$1$2":I
    nop
    ...
    .line 91
    .end local v1    # "$this$_get_Beenhere__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v2    # "$i$a$-materialIcon$default-BeenhereKt$Beenhere$1":I
