...
.method public static final getContentPasteSearch(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 45
    .param p0, "$this$ContentPasteSearch"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.ContentPasteSearch"
    ...
    .local v1, "$this$_get_ContentPasteSearch__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-ContentPasteSearchKt$ContentPasteSearch$1":I
    ...
    .local v34, "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-ContentPasteSearchKt$ContentPasteSearch$1$1":I
    ...
    .end local v34    # "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const/high16 v31, -0x3f300000    # -6.5f

    const/high16 v32, 0x40d00000    # 6.5f

    const/high16 v33, -0x3f300000    # -6.5f
    ...
    const v29, 0x4191d70a    # 18.23f

    const/high16 v30, 0x41200000    # 10.0f

    const v31, 0x418b1eb8    # 17.39f
    ...
    .line 135
    .end local v0    # "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-ContentPasteSearchKt$ContentPasteSearch$1$1":I
    nop
    ...
    .local v24, "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 46
    .local v35, "$i$a$-materialPath-YwgOQQI$default-ContentPasteSearchKt$ContentPasteSearch$1$2":I
    ...
    .end local v24    # "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-ContentPasteSearchKt$ContentPasteSearch$1":I
    .local v43, "$i$a$-materialIcon$default-ContentPasteSearchKt$ContentPasteSearch$1":I
    ...
    invoke-virtual {v0, v2, v7, v10, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v18, 0x41a35c29    # 20.42f

    const v19, 0x412cf5c3    # 10.81f

    const/high16 v20, 0x419e0000    # 19.75f
    ...
    invoke-virtual {v0, v3, v10, v7, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 173
    .end local v0    # "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-ContentPasteSearchKt$ContentPasteSearch$1$2":I
    nop
    ...
    .local v12, "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 76
    .local v22, "$i$a$-materialPath-YwgOQQI$default-ContentPasteSearchKt$ContentPasteSearch$1$3":I
    ...
    invoke-virtual {v12, v2, v15, v2, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 211
    .end local v12    # "$this$_get_ContentPasteSearch__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-ContentPasteSearchKt$ContentPasteSearch$1$3":I
    nop
    ...
    .line 110
    .end local v1    # "$this$_get_ContentPasteSearch__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v43    # "$i$a$-materialIcon$default-ContentPasteSearchKt$ContentPasteSearch$1":I
