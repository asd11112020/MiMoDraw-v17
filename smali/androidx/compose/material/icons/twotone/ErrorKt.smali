...
.method public static final getError(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$Error"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.Error"
    ...
    .local v1, "$this$_get_Error__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-ErrorKt$Error$1":I
    ...
    .local v16, "$this$_get_Error__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-ErrorKt$Error$1$1":I
    ...
    .end local v16    # "$this$_get_Error__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_Error__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-ErrorKt$Error$1":I
    ...
    .line 116
    .end local v2    # "$this$_get_Error__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-ErrorKt$Error$1$1":I
    nop
    ...
    .local v24, "$this$_get_Error__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 51
    .local v35, "$i$a$-materialPath-YwgOQQI$default-ErrorKt$Error$1$2":I
    const v10, 0x413fd70a    # 11.99f

    move-object/from16 v0, v24

    .end local v24    # "$this$_get_Error__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_Error__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_Error__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_Error__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 154
    .end local v0    # "$this$_get_Error__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-ErrorKt$Error$1$2":I
    nop
    ...
    .line 91
    .end local v41    # "$i$a$-materialIcon$default-ErrorKt$Error$1":I
    .end local v42    # "$this$_get_Error__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
