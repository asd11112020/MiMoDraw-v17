...
.method public static final getRouter(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 44
    .param p0, "$this$Router"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.Router"
    ...
    .local v1, "$this$_get_Router__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-RouterKt$Router$1":I
    ...
    .local v27, "$this$_get_Router__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-RouterKt$Router$1$1":I
    const/high16 v7, 0x41700000    # 15.0f

    move-object/from16 v10, v27

    .end local v27    # "$this$_get_Router__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_Router__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 152
    .end local v10    # "$this$_get_Router__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-RouterKt$Router$1$1":I
    nop
    ...
    .local v15, "$this$_get_Router__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 58
    .local v22, "$i$a$-materialPath-YwgOQQI$default-RouterKt$Router$1$2":I
    ...
    .end local v15    # "$this$_get_Router__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v7, "$this$_get_Router__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_Router__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_Router__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const v1, -0x3f99999a    # -3.6f

    move/from16 v43, v2

    .end local v2    # "$i$a$-materialIcon$default-RouterKt$Router$1":I
    .local v43, "$i$a$-materialIcon$default-RouterKt$Router$1":I
    const v2, 0x3f333333    # 0.7f

    invoke-virtual {v7, v1, v2, v15, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v7, v2, v15, v0, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 190
    .end local v7    # "$this$_get_Router__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-RouterKt$Router$1$2":I
    nop
    ...
    .line 127
    .end local v42    # "$this$_get_Router__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v43    # "$i$a$-materialIcon$default-RouterKt$Router$1":I
