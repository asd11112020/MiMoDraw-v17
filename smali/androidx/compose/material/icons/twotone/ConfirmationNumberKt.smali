...
.method public static final getConfirmationNumber(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 44
    .param p0, "$this$ConfirmationNumber"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.ConfirmationNumber"
    ...
    .local v1, "$this$_get_ConfirmationNumber__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-ConfirmationNumberKt$ConfirmationNumber$1":I
    ...
    .local v16, "$this$_get_ConfirmationNumber__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-ConfirmationNumberKt$ConfirmationNumber$1$1":I
    ...
    .end local v16    # "$this$_get_ConfirmationNumber__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_ConfirmationNumber__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-ConfirmationNumberKt$ConfirmationNumber$1":I
    ...
    invoke-virtual {v2, v10, v0, v3, v4}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v3, v4, v10, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 149
    .end local v2    # "$this$_get_ConfirmationNumber__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-ConfirmationNumberKt$ConfirmationNumber$1$1":I
    nop
    ...
    .local v24, "$this$_get_ConfirmationNumber__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 63
    .local v35, "$i$a$-materialPath-YwgOQQI$default-ConfirmationNumberKt$ConfirmationNumber$1$2":I
    ...
    .end local v24    # "$this$_get_ConfirmationNumber__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_ConfirmationNumber__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_ConfirmationNumber__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v43, "$this$_get_ConfirmationNumber__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    invoke-virtual {v10, v0, v3, v2, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v10, v1, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 187
    .end local v10    # "$this$_get_ConfirmationNumber__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-ConfirmationNumberKt$ConfirmationNumber$1$2":I
    nop
    ...
    .line 124
    .end local v41    # "$i$a$-materialIcon$default-ConfirmationNumberKt$ConfirmationNumber$1":I
    .end local v43    # "$this$_get_ConfirmationNumber__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
