...
.method public static final getAlarmAdd(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$AlarmAdd"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.AlarmAdd"
    ...
    .local v1, "$this$_get_AlarmAdd__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-AlarmAddKt$AlarmAdd$1":I
    ...
    .local v16, "$this$_get_AlarmAdd__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-AlarmAddKt$AlarmAdd$1$1":I
    ...
    .end local v16    # "$this$_get_AlarmAdd__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_AlarmAdd__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-AlarmAddKt$AlarmAdd$1":I
    ...
    .line 131
    .end local v2    # "$this$_get_AlarmAdd__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-AlarmAddKt$AlarmAdd$1$1":I
    nop
    ...
    .local v15, "$this$_get_AlarmAdd__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 53
    .local v22, "$i$a$-materialPath-YwgOQQI$default-AlarmAddKt$AlarmAdd$1$2":I
    const v10, 0x418ab22d    # 17.337f
    ...
    .line 54
    const v10, 0x40936c8b    # 4.607f

    const v3, 0x4076147b    # 3.845f

    invoke-virtual {v15, v10, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 55
    const v3, 0x3fc47ae1    # 1.535f
    ...
    const v10, -0x3f8a0c4a    # -3.843f

    invoke-virtual {v15, v3, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 59
    const v3, 0x3fa41893    # 1.282f

    const v10, 0x3fc49ba6    # 1.536f
    ...
    .end local v15    # "$this$_get_AlarmAdd__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v3, "$this$_get_AlarmAdd__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 169
    .end local v3    # "$this$_get_AlarmAdd__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-AlarmAddKt$AlarmAdd$1$2":I
    nop
    ...
    .line 106
    .end local v1    # "$this$_get_AlarmAdd__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-AlarmAddKt$AlarmAdd$1":I
