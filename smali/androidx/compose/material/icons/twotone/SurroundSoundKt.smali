...
.method public static final getSurroundSound(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.SurroundSound"
    ...
    .line 30
    .local v2, "$i$a$-materialIcon$default-SurroundSoundKt$SurroundSound$1":I
    ...
    .local v34, "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$1":I
    ...
    .end local v34    # "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-SurroundSoundKt$SurroundSound$1":I
    .local v43, "$i$a$-materialIcon$default-SurroundSoundKt$SurroundSound$1":I
    ...
    invoke-virtual {v0, v2, v3, v7, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v7, v3, v2, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$1":I
    nop
    ...
    .local v15, "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 61
    .local v22, "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$2":I
    const/high16 v2, 0x41a00000    # 20.0f

    const/high16 v10, 0x40800000    # 4.0f

    invoke-virtual {v15, v2, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v15    # "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v10, v2, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 72
    const/high16 v2, 0x40800000    # 4.0f

    invoke-virtual {v10, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->horizontalLineTo(F)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 73
    const/high16 v2, 0x40c00000    # 6.0f

    invoke-virtual {v10, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->verticalLineTo(F)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 192
    .end local v10    # "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$2":I
    nop
    ...
    .local v11, "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 79
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$3":I
    ...
    .line 230
    .end local v11    # "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$3":I
    nop
    ...
    .local v11, "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 89
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$4":I
    ...
    .line 98
    invoke-virtual {v11, v2, v15, v2, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 268
    .end local v11    # "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$4":I
    nop
    ...
    .local v11, "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 103
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$5":I
    ...
    .local v40, "$this$_get_SurroundSound__u24lambda_u245":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    const v17, 0x4155999a    # 13.35f

    const v18, 0x4185d70a    # 16.73f

    const v19, 0x416b0a3d    # 14.69f

    const v20, 0x417b851f    # 15.72f
    ...
    .line 306
    .end local v11    # "$this$_get_SurroundSound__u24lambda_u245_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SurroundSoundKt$SurroundSound$1$5":I
    nop
    ...
    .line 129
    .end local v40    # "$this$_get_SurroundSound__u24lambda_u245":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v43    # "$i$a$-materialIcon$default-SurroundSoundKt$SurroundSound$1":I
