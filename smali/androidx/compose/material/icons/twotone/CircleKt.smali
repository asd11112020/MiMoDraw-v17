...
.method public static final getCircle(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 45
    .param p0, "$this$Circle"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.Circle"
    ...
    .local v1, "$this$_get_Circle__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-CircleKt$Circle$1":I
    ...
    .local v16, "$this$_get_Circle__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v27, 0x0

    .line 31
    .local v27, "$i$a$-materialPath-YwgOQQI$default-CircleKt$Circle$1$1":I
    ...
    .end local v16    # "$this$_get_Circle__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_Circle__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-CircleKt$Circle$1":I
    .local v44, "$i$a$-materialIcon$default-CircleKt$Circle$1":I
    const/4 v2, 0x0

    invoke-virtual {v0, v10, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 92
    .end local v0    # "$this$_get_Circle__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v27    # "$i$a$-materialPath-YwgOQQI$default-CircleKt$Circle$1$1":I
    nop
    ...
    .local v11, "$this$_get_Circle__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 37
    .local v12, "$i$a$-materialPath-YwgOQQI$default-CircleKt$Circle$1$2":I
    ...
    .end local v1    # "$this$_get_Circle__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v40, "$this$_get_Circle__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 130
    .end local v11    # "$this$_get_Circle__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-CircleKt$Circle$1$2":I
    nop
    ...
    .line 67
    .end local v40    # "$this$_get_Circle__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v44    # "$i$a$-materialIcon$default-CircleKt$Circle$1":I
