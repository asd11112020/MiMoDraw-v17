...
.method public static final getNature(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$Nature"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.Nature"
    ...
    .local v1, "$this$_get_Nature__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-NatureKt$Nature$1":I
    ...
    .local v16, "$this$_get_Nature__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-NatureKt$Nature$1$1":I
    ...
    .end local v16    # "$this$_get_Nature__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_Nature__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-NatureKt$Nature$1":I
    ...
    .line 102
    .end local v2    # "$this$_get_Nature__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-NatureKt$Nature$1$1":I
    nop
    ...
    .local v24, "$this$_get_Nature__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 39
    .local v35, "$i$a$-materialPath-YwgOQQI$default-NatureKt$Nature$1$2":I
    ...
    .end local v24    # "$this$_get_Nature__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_Nature__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_Nature__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_Nature__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/high16 v1, -0x3f200000    # -7.0f

    invoke-virtual {v0, v1, v3, v1, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 140
    .end local v0    # "$this$_get_Nature__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-NatureKt$Nature$1$2":I
    nop
    ...
    .line 77
    .end local v41    # "$i$a$-materialIcon$default-NatureKt$Nature$1":I
    .end local v42    # "$this$_get_Nature__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
