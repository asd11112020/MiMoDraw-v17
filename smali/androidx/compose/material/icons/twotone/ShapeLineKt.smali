...
.method public static final getShapeLine(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.ShapeLine"
    ...
    .line 30
    .local v2, "$i$a$-materialIcon$default-ShapeLineKt$ShapeLine$1":I
    ...
    .local v27, "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$1":I
    const/high16 v7, 0x41800000    # 16.0f

    move-object/from16 v10, v27

    .end local v27    # "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 133
    .end local v10    # "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$1":I
    nop
    ...
    .local v15, "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v24, 0x0

    .line 38
    .local v24, "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$2":I
    ...
    invoke-virtual {v15, v0, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v15    # "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v7, "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 171
    .end local v7    # "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v24    # "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$2":I
    nop
    ...
    .local v15, "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 44
    .local v22, "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$3":I
    ...
    .end local v2    # "$i$a$-materialIcon$default-ShapeLineKt$ShapeLine$1":I
    .local v42, "$i$a$-materialIcon$default-ShapeLineKt$ShapeLine$1":I
    ...
    .end local v15    # "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v15, v3, v0, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 47
    const v15, 0x404f5c29    # 3.24f

    invoke-virtual {v2, v3, v15, v3, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v3, v0, v3, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 209
    .end local v2    # "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$3":I
    nop
    ...
    .local v12, "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 58
    .local v22, "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$4":I
    ...
    .line 68
    invoke-virtual {v12, v3, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 247
    .end local v12    # "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$4":I
    nop
    ...
    .local v11, "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 76
    .local v12, "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$5":I
    ...
    .line 77
    const v16, 0x4190e148    # 18.11f

    const v17, 0x40fc7ae1    # 7.89f

    const v18, 0x419451ec    # 18.54f
    ...
    .local v40, "$this$_get_ShapeLine__u24lambda_u245":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    move-object v15, v11
    ...
    invoke-virtual {v11, v0, v1, v0, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 285
    .end local v11    # "$this$_get_ShapeLine__u24lambda_u245_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-ShapeLineKt$ShapeLine$1$5":I
    nop
    ...
    .line 108
    .end local v40    # "$this$_get_ShapeLine__u24lambda_u245":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v42    # "$i$a$-materialIcon$default-ShapeLineKt$ShapeLine$1":I
