...
.method public static final getSendAndArchive(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$SendAndArchive"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 35
    :cond_0
    const-string/jumbo v0, "TwoTone.SendAndArchive"
    ...
    .local v34, "$this$_get_SendAndArchive__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 37
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$1":I
    ...
    .end local v34    # "$this$_get_SendAndArchive__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SendAndArchive__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 125
    .end local v0    # "$this$_get_SendAndArchive__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$1":I
    nop
    ...
    .local v12, "$this$_get_SendAndArchive__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 50
    .local v22, "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$2":I
    ...
    .end local v2    # "$i$a$-materialIcon$default-SendAndArchiveKt$SendAndArchive$1":I
    .local v42, "$i$a$-materialIcon$default-SendAndArchiveKt$SendAndArchive$1":I
    move-object v15, v12
    ...
    .line 163
    .end local v12    # "$this$_get_SendAndArchive__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$2":I
    nop
    ...
    .local v11, "$this$_get_SendAndArchive__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 67
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$3":I
    ...
    .local v17, "$this$_get_SendAndArchive__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 201
    .end local v11    # "$this$_get_SendAndArchive__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$3":I
    nop
    ...
    .line 100
    .end local v17    # "$this$_get_SendAndArchive__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v42    # "$i$a$-materialIcon$default-SendAndArchiveKt$SendAndArchive$1":I
