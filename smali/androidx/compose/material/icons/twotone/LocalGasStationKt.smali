...
.method public static final getLocalGasStation(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$LocalGasStation"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.LocalGasStation"
    ...
    .local v1, "$this$_get_LocalGasStation__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-LocalGasStationKt$LocalGasStation$1":I
    ...
    .local v27, "$this$_get_LocalGasStation__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-LocalGasStationKt$LocalGasStation$1$1":I
    ...
    .end local v27    # "$this$_get_LocalGasStation__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_LocalGasStation__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 128
    .end local v0    # "$this$_get_LocalGasStation__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-LocalGasStationKt$LocalGasStation$1$1":I
    nop
    ...
    .local v24, "$this$_get_LocalGasStation__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v37, 0x0

    .line 38
    .local v37, "$i$a$-materialPath-YwgOQQI$default-LocalGasStationKt$LocalGasStation$1$2":I
    ...
    .end local v24    # "$this$_get_LocalGasStation__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_LocalGasStation__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_LocalGasStation__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_LocalGasStation__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/high16 v1, 0x40200000    # 2.5f

    invoke-virtual {v0, v1, v10, v1, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v1, v7, v1, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v1, v7, v10, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v1, v10, v7, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 166
    .end local v0    # "$this$_get_LocalGasStation__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v37    # "$i$a$-materialPath-YwgOQQI$default-LocalGasStationKt$LocalGasStation$1$2":I
    nop
    ...
    .line 103
    .end local v2    # "$i$a$-materialIcon$default-LocalGasStationKt$LocalGasStation$1":I
    .end local v42    # "$this$_get_LocalGasStation__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
