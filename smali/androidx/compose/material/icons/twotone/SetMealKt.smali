...
.method public static final getSetMeal(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 44
    .param p0, "$this$SetMeal"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.SetMeal"
    ...
    .local v1, "$this$_get_SetMeal__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SetMealKt$SetMeal$1":I
    ...
    .local v16, "$this$_get_SetMeal__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SetMealKt$SetMeal$1$1":I
    ...
    .end local v16    # "$this$_get_SetMeal__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_SetMeal__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-SetMealKt$SetMeal$1":I
    ...
    .line 128
    .end local v2    # "$this$_get_SetMeal__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SetMealKt$SetMeal$1$1":I
    nop
    ...
    .local v15, "$this$_get_SetMeal__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 48
    .local v22, "$i$a$-materialPath-YwgOQQI$default-SetMealKt$SetMeal$1$2":I
    const v0, 0x41a86666    # 21.05f

    const v10, 0x418c7ae1    # 17.56f
    ...
    .end local v15    # "$this$_get_SetMeal__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SetMeal__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const/high16 v18, -0x3f280000    # -6.75f

    const/high16 v19, 0x40400000    # 3.0f

    const/high16 v20, -0x3f280000    # -6.75f
    ...
    .end local v1    # "$this$_get_SetMeal__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_SetMeal__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 166
    .end local v0    # "$this$_get_SetMeal__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-SetMealKt$SetMeal$1$2":I
    nop
    ...
    .line 103
    .end local v41    # "$i$a$-materialIcon$default-SetMealKt$SetMeal$1":I
    .end local v42    # "$this$_get_SetMeal__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
