...
.method public static final getVideogameAssetOff(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$VideogameAssetOff"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.VideogameAssetOff"
    ...
    .local v1, "$this$_get_VideogameAssetOff__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-VideogameAssetOffKt$VideogameAssetOff$1":I
    ...
    .local v16, "$this$_get_VideogameAssetOff__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-VideogameAssetOffKt$VideogameAssetOff$1$1":I
    ...
    .end local v16    # "$this$_get_VideogameAssetOff__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_VideogameAssetOff__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-VideogameAssetOffKt$VideogameAssetOff$1":I
    ...
    invoke-virtual {v2, v3, v0, v3, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 146
    .end local v2    # "$this$_get_VideogameAssetOff__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-VideogameAssetOffKt$VideogameAssetOff$1$1":I
    nop
    ...
    .local v15, "$this$_get_VideogameAssetOff__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 60
    .local v22, "$i$a$-materialPath-YwgOQQI$default-VideogameAssetOffKt$VideogameAssetOff$1$2":I
    const/high16 v3, 0x41100000    # 9.0f
    ...
    .end local v15    # "$this$_get_VideogameAssetOff__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v3, "$this$_get_VideogameAssetOff__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v3, v10, v15, v0, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v3, v0, v10, v0, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v3, v0, v15, v10, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v3, v0, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 184
    .end local v3    # "$this$_get_VideogameAssetOff__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-VideogameAssetOffKt$VideogameAssetOff$1$2":I
    nop
    ...
    .line 121
    .end local v1    # "$this$_get_VideogameAssetOff__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-VideogameAssetOffKt$VideogameAssetOff$1":I
