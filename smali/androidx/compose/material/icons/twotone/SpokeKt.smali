...
.method public static final getSpoke(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 44
    .param p0, "$this$Spoke"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.Spoke"
    ...
    .local v1, "$this$_get_Spoke__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SpokeKt$Spoke$1":I
    ...
    .local v16, "$this$_get_Spoke__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SpokeKt$Spoke$1$1":I
    ...
    .end local v16    # "$this$_get_Spoke__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_Spoke__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-SpokeKt$Spoke$1":I
    ...
    .line 130
    .end local v2    # "$this$_get_Spoke__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SpokeKt$Spoke$1$1":I
    nop
    ...
    .local v11, "$this$_get_Spoke__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 51
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SpokeKt$Spoke$1$2":I
    ...
    .end local v1    # "$this$_get_Spoke__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_Spoke__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    invoke-virtual {v11, v1, v2, v1, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 168
    .end local v11    # "$this$_get_Spoke__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SpokeKt$Spoke$1$2":I
    nop
    ...
    .line 105
    .end local v41    # "$i$a$-materialIcon$default-SpokeKt$Spoke$1":I
    .end local v42    # "$this$_get_Spoke__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
