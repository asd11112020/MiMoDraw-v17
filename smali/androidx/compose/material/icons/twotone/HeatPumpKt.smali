...
.method public static final getHeatPump(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$HeatPump"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.HeatPump"
    ...
    .local v1, "$this$_get_HeatPump__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-HeatPumpKt$HeatPump$1":I
    ...
    .local v34, "$this$_get_HeatPump__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0
    ...
    .end local v34    # "$this$_get_HeatPump__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_HeatPump__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-HeatPumpKt$HeatPump$1":I
    .local v42, "$i$a$-materialIcon$default-HeatPumpKt$HeatPump$1":I
    const/high16 v2, -0x3f400000    # -6.0f

    invoke-virtual {v0, v10, v7, v2, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 158
    .end local v0    # "$this$_get_HeatPump__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v15, "$this$_get_HeatPump__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 45
    .local v22, "$i$a$-materialPath-YwgOQQI$default-HeatPumpKt$HeatPump$1$2":I
    ...
    .end local v15    # "$this$_get_HeatPump__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_HeatPump__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 196
    .end local v2    # "$this$_get_HeatPump__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-HeatPumpKt$HeatPump$1$2":I
    nop
    ...
    .local v11, "$this$_get_HeatPump__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 63
    .local v12, "$i$a$-materialPath-YwgOQQI$default-HeatPumpKt$HeatPump$1$3":I
    ...
    .end local v1    # "$this$_get_HeatPump__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v40, "$this$_get_HeatPump__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    invoke-virtual {v11, v1, v0, v15, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v19, 0x417d1eb8    # 15.82f

    const/high16 v20, 0x414c0000    # 12.75f

    const v21, 0x417eb852    # 15.92f
    ...
    invoke-virtual {v11, v1, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v11, v15, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v19, 0x412b3333    # 10.7f

    const v20, 0x417eb852    # 15.92f
    ...
    invoke-virtual {v11, v15, v1, v15, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v11, v15, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v11, v1, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 234
    .end local v11    # "$this$_get_HeatPump__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-HeatPumpKt$HeatPump$1$3":I
    nop
    ...
    .line 133
    .end local v40    # "$this$_get_HeatPump__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v42    # "$i$a$-materialIcon$default-HeatPumpKt$HeatPump$1":I
