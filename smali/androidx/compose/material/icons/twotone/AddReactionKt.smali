...
.method public static final getAddReaction(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$AddReaction"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.AddReaction"
    ...
    .local v1, "$this$_get_AddReaction__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-AddReactionKt$AddReaction$1":I
    ...
    .local v34, "$this$_get_AddReaction__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-AddReactionKt$AddReaction$1$1":I
    ...
    .end local v34    # "$this$_get_AddReaction__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_AddReaction__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 36
    const v28, 0x416d1eb8    # 14.82f

    const v29, 0x408ccccd    # 4.4f

    const v30, 0x41575c29    # 13.46f
    ...
    invoke-virtual {v0, v10, v7, v7, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-AddReactionKt$AddReaction$1":I
    .local v41, "$i$a$-materialIcon$default-AddReactionKt$AddReaction$1":I
    ...
    const v30, 0x419e51ec    # 19.79f

    const v31, 0x411ee148    # 9.93f

    const v32, 0x419b47ae    # 19.41f
    ...
    .line 57
    const v28, 0x41827ae1    # 16.31f

    const v29, 0x418051ec    # 16.04f

    const v30, 0x416547ae    # 14.33f
    ...
    .line 149
    .end local v0    # "$this$_get_AddReaction__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-AddReactionKt$AddReaction$1$1":I
    nop
    ...
    .local v15, "$this$_get_AddReaction__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 61
    .local v22, "$i$a$-materialPath-YwgOQQI$default-AddReactionKt$AddReaction$1$2":I
    const/high16 v10, 0x40e00000    # 7.0f
    ...
    .end local v15    # "$this$_get_AddReaction__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_AddReaction__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v10, v15, v0, v15, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v10, v0, v15, v0, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v17, 0x418051ec    # 16.04f

    const v18, 0x411ab852    # 9.67f
    ...
    .line 187
    .end local v10    # "$this$_get_AddReaction__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-AddReactionKt$AddReaction$1$2":I
    nop
    ...
    .line 124
    .end local v1    # "$this$_get_AddReaction__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-AddReactionKt$AddReaction$1":I
