...
.method public static final getAddAlert(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$AddAlert"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.AddAlert"
    ...
    .local v1, "$this$_get_AddAlert__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-AddAlertKt$AddAlert$1":I
    ...
    .local v34, "$this$_get_AddAlert__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-AddAlertKt$AddAlert$1$1":I
    ...
    .end local v34    # "$this$_get_AddAlert__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_AddAlert__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 137
    .end local v0    # "$this$_get_AddAlert__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-AddAlertKt$AddAlert$1$1":I
    nop
    ...
    .local v15, "$this$_get_AddAlert__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 54
    .local v22, "$i$a$-materialPath-YwgOQQI$default-AddAlertKt$AddAlert$1$2":I
    ...
    .end local v15    # "$this$_get_AddAlert__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_AddAlert__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v19, -0x3f3b3333    # -6.15f

    const/high16 v20, -0x3f500000    # -5.5f

    const v21, -0x3f2570a4    # -6.83f
    ...
    .end local v1    # "$this$_get_AddAlert__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v41, "$this$_get_AddAlert__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 175
    .end local v0    # "$this$_get_AddAlert__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-AddAlertKt$AddAlert$1$2":I
    nop
    ...
    .line 112
    .end local v2    # "$i$a$-materialIcon$default-AddAlertKt$AddAlert$1":I
    .end local v41    # "$this$_get_AddAlert__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
