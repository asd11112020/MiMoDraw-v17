...
.method public static final getSpatialTracking(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 44
    .param p0, "$this$SpatialTracking"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.SpatialTracking"
    ...
    .local v1, "$this$_get_SpatialTracking__u24lambda_u246":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SpatialTrackingKt$SpatialTracking$1":I
    move-object v3, v1
    ...
    .local v35, "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$1":I
    ...
    .end local v35    # "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v31, -0x3f9f5c29    # -3.51f

    const v32, 0x41135c29    # 9.21f

    const/16 v33, 0x0

    const v34, 0x414bae14    # 12.73f
    ...
    .line 35
    const v29, 0x418a8f5c    # 17.32f

    const v30, 0x411947ae    # 9.58f

    const v31, 0x418a8f5c    # 17.32f

    const v32, 0x40a47ae1    # 5.14f

    const v33, 0x41a06666    # 20.05f

    const v34, 0x401a3d71    # 2.41f
    ...
    .line 139
    .end local v0    # "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$1":I
    nop
    ...
    .local v24, "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 39
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$2":I
    const v8, 0x41b70a3d    # 22.88f
    ...
    .end local v24    # "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v18, 0x41051eb8    # 8.32f

    const v19, 0x41adae14    # 21.71f

    const v20, 0x40cd1eb8    # 6.41f

    const v21, 0x41b70a3d    # 22.88f

    const v22, 0x40a7ae14    # 5.24f
    ...
    .line 177
    .end local v0    # "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$2":I
    nop
    ...
    .local v11, "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 47
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$3":I
    ...
    .line 215
    .end local v11    # "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$3":I
    nop
    ...
    .local v12, "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v24, 0x0

    .line 58
    .local v24, "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$4":I
    ...
    .line 253
    .end local v12    # "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v24    # "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$4":I
    nop
    ...
    .local v15, "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 64
    .local v22, "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$5":I
    move/from16 v42, v2

    .end local v2    # "$i$a$-materialIcon$default-SpatialTrackingKt$SpatialTracking$1":I
    .local v42, "$i$a$-materialIcon$default-SpatialTrackingKt$SpatialTracking$1":I
    ...
    .end local v15    # "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    invoke-virtual/range {v15 .. v21}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveToRelative(FFFFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v0, v15, v0, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 291
    .end local v2    # "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$5":I
    nop
    ...
    .local v11, "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u245":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 78
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$6":I
    ...
    .line 329
    .end local v11    # "$this$_get_SpatialTracking__u24lambda_u246_u24lambda_u245":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SpatialTrackingKt$SpatialTracking$1$6":I
    nop
    ...
    .line 114
    .end local v1    # "$this$_get_SpatialTracking__u24lambda_u246":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v42    # "$i$a$-materialIcon$default-SpatialTrackingKt$SpatialTracking$1":I
