...
.method public static final getRemoveModerator(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$RemoveModerator"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.RemoveModerator"
    ...
    .local v1, "$this$_get_RemoveModerator__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-RemoveModeratorKt$RemoveModerator$1":I
    ...
    .local v16, "$this$_get_RemoveModerator__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-RemoveModeratorKt$RemoveModerator$1$1":I
    ...
    .end local v16    # "$this$_get_RemoveModerator__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_RemoveModerator__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-RemoveModeratorKt$RemoveModerator$1":I
    ...
    .line 117
    .end local v2    # "$this$_get_RemoveModerator__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-RemoveModeratorKt$RemoveModerator$1$1":I
    nop
    ...
    .local v11, "$this$_get_RemoveModerator__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 46
    .local v12, "$i$a$-materialPath-YwgOQQI$default-RemoveModeratorKt$RemoveModerator$1$2":I
    ...
    .line 155
    .end local v11    # "$this$_get_RemoveModerator__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-RemoveModeratorKt$RemoveModerator$1$2":I
    nop
    ...
    .line 92
    .end local v1    # "$this$_get_RemoveModerator__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-RemoveModeratorKt$RemoveModerator$1":I
