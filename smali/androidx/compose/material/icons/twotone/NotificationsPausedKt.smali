...
.method public static final getNotificationsPaused(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$NotificationsPaused"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.NotificationsPaused"
    ...
    .local v1, "$this$_get_NotificationsPaused__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-NotificationsPausedKt$NotificationsPaused$1":I
    ...
    .local v34, "$this$_get_NotificationsPaused__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-NotificationsPausedKt$NotificationsPaused$1$1":I
    ...
    .end local v34    # "$this$_get_NotificationsPaused__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_NotificationsPaused__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 133
    .end local v0    # "$this$_get_NotificationsPaused__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-NotificationsPausedKt$NotificationsPaused$1$1":I
    nop
    ...
    .local v15, "$this$_get_NotificationsPaused__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 52
    .local v22, "$i$a$-materialPath-YwgOQQI$default-NotificationsPausedKt$NotificationsPaused$1$2":I
    ...
    .end local v15    # "$this$_get_NotificationsPaused__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v10, "$this$_get_NotificationsPaused__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_NotificationsPaused__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v41, "$this$_get_NotificationsPaused__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/high16 v1, -0x40400000    # -1.5f

    invoke-virtual {v10, v1, v15, v1, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 171
    .end local v10    # "$this$_get_NotificationsPaused__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-NotificationsPausedKt$NotificationsPaused$1$2":I
    nop
    ...
    .line 108
    .end local v2    # "$i$a$-materialIcon$default-NotificationsPausedKt$NotificationsPaused$1":I
    .end local v41    # "$this$_get_NotificationsPaused__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
