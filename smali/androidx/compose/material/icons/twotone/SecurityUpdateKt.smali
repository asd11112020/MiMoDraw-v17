...
.method public static final getSecurityUpdate(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 48
    .param p0, "$this$SecurityUpdate"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.SecurityUpdate"
    ...
    .local v1, "$this$_get_SecurityUpdate__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SecurityUpdateKt$SecurityUpdate$1":I
    ...
    .local v27, "$this$_get_SecurityUpdate__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-SecurityUpdateKt$SecurityUpdate$1$1":I
    ...
    .end local v27    # "$this$_get_SecurityUpdate__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SecurityUpdate__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 125
    .end local v0    # "$this$_get_SecurityUpdate__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-SecurityUpdateKt$SecurityUpdate$1$1":I
    nop
    ...
    .local v15, "$this$_get_SecurityUpdate__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v16, 0x0

    .line 38
    .local v16, "$i$a$-materialPath-YwgOQQI$default-SecurityUpdateKt$SecurityUpdate$1$2":I
    ...
    .line 163
    .end local v15    # "$this$_get_SecurityUpdate__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v16    # "$i$a$-materialPath-YwgOQQI$default-SecurityUpdateKt$SecurityUpdate$1$2":I
    nop
    ...
    .local v15, "$this$_get_SecurityUpdate__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v16, 0x0

    .line 45
    .local v16, "$i$a$-materialPath-YwgOQQI$default-SecurityUpdateKt$SecurityUpdate$1$3":I
    ...
    .line 201
    .end local v15    # "$this$_get_SecurityUpdate__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v16    # "$i$a$-materialPath-YwgOQQI$default-SecurityUpdateKt$SecurityUpdate$1$3":I
    nop
    ...
    .line 100
    .end local v1    # "$this$_get_SecurityUpdate__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v2    # "$i$a$-materialIcon$default-SecurityUpdateKt$SecurityUpdate$1":I
