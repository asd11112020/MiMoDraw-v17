...
.method public static final getStayPrimaryPortrait(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$StayPrimaryPortrait"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.StayPrimaryPortrait"
    ...
    .local v1, "$this$_get_StayPrimaryPortrait__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-StayPrimaryPortraitKt$StayPrimaryPortrait$1":I
    ...
    .local v27, "$this$_get_StayPrimaryPortrait__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-StayPrimaryPortraitKt$StayPrimaryPortrait$1$1":I
    ...
    .end local v27    # "$this$_get_StayPrimaryPortrait__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_StayPrimaryPortrait__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 97
    .end local v0    # "$this$_get_StayPrimaryPortrait__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-StayPrimaryPortraitKt$StayPrimaryPortrait$1$1":I
    nop
    ...
    .local v24, "$this$_get_StayPrimaryPortrait__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v38, 0x0

    .line 38
    .local v38, "$i$a$-materialPath-YwgOQQI$default-StayPrimaryPortraitKt$StayPrimaryPortrait$1$2":I
    ...
    .end local v24    # "$this$_get_StayPrimaryPortrait__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_StayPrimaryPortrait__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 135
    .end local v0    # "$this$_get_StayPrimaryPortrait__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v38    # "$i$a$-materialPath-YwgOQQI$default-StayPrimaryPortraitKt$StayPrimaryPortrait$1$2":I
    nop
    ...
    .line 72
    .end local v1    # "$this$_get_StayPrimaryPortrait__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v2    # "$i$a$-materialIcon$default-StayPrimaryPortraitKt$StayPrimaryPortrait$1":I
