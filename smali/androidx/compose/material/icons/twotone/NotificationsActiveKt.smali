...
.method public static final getNotificationsActive(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$NotificationsActive"    # Landroidx/compose/material/icons/Icons$TwoTone;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "TwoTone.NotificationsActive"
    ...
    .local v1, "$this$_get_NotificationsActive__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-NotificationsActiveKt$NotificationsActive$1":I
    ...
    .local v34, "$this$_get_NotificationsActive__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-NotificationsActiveKt$NotificationsActive$1$1":I
    ...
    .end local v34    # "$this$_get_NotificationsActive__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_NotificationsActive__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 122
    .end local v0    # "$this$_get_NotificationsActive__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-NotificationsActiveKt$NotificationsActive$1$1":I
    nop
    ...
    .local v24, "$this$_get_NotificationsActive__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 40
    .local v35, "$i$a$-materialPath-YwgOQQI$default-NotificationsActiveKt$NotificationsActive$1$2":I
    ...
    .end local v24    # "$this$_get_NotificationsActive__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_NotificationsActive__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_NotificationsActive__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_NotificationsActive__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/high16 v1, -0x40400000    # -1.5f

    invoke-virtual {v0, v1, v7, v1, v10}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v10, v1, v10, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v20, -0x3f3f5c29    # -6.02f

    const v21, -0x3f7c28f6    # -4.12f

    const v22, -0x3f04cccd    # -7.85f
    ...
    .line 160
    .end local v0    # "$this$_get_NotificationsActive__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-NotificationsActiveKt$NotificationsActive$1$2":I
    nop
    ...
    .line 97
    .end local v2    # "$i$a$-materialIcon$default-NotificationsActiveKt$NotificationsActive$1":I
    .end local v42    # "$this$_get_NotificationsActive__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
