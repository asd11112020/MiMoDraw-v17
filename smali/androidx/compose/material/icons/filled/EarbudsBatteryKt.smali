...
.method public static final getEarbudsBattery(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$EarbudsBattery"    # Landroidx/compose/material/icons/Icons$Filled;
    ...
    .line 29
    :cond_0
    const-string v0, "Filled.EarbudsBattery"
    ...
    .local v1, "$this$_get_EarbudsBattery__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v35, "$this$_get_EarbudsBattery__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-EarbudsBatteryKt$EarbudsBattery$1$1":I
    ...
    .end local v35    # "$this$_get_EarbudsBattery__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_EarbudsBattery__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 114
    .end local v0    # "$this$_get_EarbudsBattery__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-EarbudsBatteryKt$EarbudsBattery$1$1":I
    nop
    ...
    .local v24, "$this$_get_EarbudsBattery__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 47
    .local v36, "$i$a$-materialPath-YwgOQQI$default-EarbudsBatteryKt$EarbudsBattery$1$2":I
    ...
    .end local v24    # "$this$_get_EarbudsBattery__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v8, "$this$_get_EarbudsBattery__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_EarbudsBattery__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_EarbudsBattery__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/high16 v1, 0x40600000    # 3.5f

    invoke-virtual {v8, v1, v0, v1, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v8, v0, v11, v1, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v8, v1, v0, v1, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 152
    .end local v8    # "$this$_get_EarbudsBattery__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-EarbudsBatteryKt$EarbudsBattery$1$2":I
    nop
    ...
    .end local v42    # "$this$_get_EarbudsBattery__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
