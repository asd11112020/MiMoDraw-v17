...
.method public static final getAttachEmail(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$AttachEmail"    # Landroidx/compose/material/icons/Icons$Filled;
    ...
    .line 29
    :cond_0
    const-string v0, "Filled.AttachEmail"
    ...
    .local v1, "$this$_get_AttachEmail__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-AttachEmailKt$AttachEmail$1":I
    move-object v3, v1
    ...
    .local v35, "$this$_get_AttachEmail__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-AttachEmailKt$AttachEmail$1$1":I
    ...
    .end local v35    # "$this$_get_AttachEmail__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_AttachEmail__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 114
    .end local v0    # "$this$_get_AttachEmail__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-AttachEmailKt$AttachEmail$1$1":I
    nop
    ...
    .local v15, "$this$_get_AttachEmail__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 53
    .local v22, "$i$a$-materialPath-YwgOQQI$default-AttachEmailKt$AttachEmail$1$2":I
    ...
    .end local v15    # "$this$_get_AttachEmail__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_AttachEmail__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v8, v15, v8, v8}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_AttachEmail__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_AttachEmail__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/high16 v1, 0x41700000    # 15.0f

    invoke-virtual {v0, v1, v15, v1, v8}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v15, v1, v15, v8}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 152
    .end local v0    # "$this$_get_AttachEmail__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-AttachEmailKt$AttachEmail$1$2":I
    nop
    ...
    .line 89
    .end local v2    # "$i$a$-materialIcon$default-AttachEmailKt$AttachEmail$1":I
    .end local v42    # "$this$_get_AttachEmail__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
