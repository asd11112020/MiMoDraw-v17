...
.method public static final getLogout(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$Logout"    # Landroidx/compose/material/icons/Icons$Sharp;
    ...
    .line 35
    :cond_0
    const-string/jumbo v0, "Sharp.Logout"
    ...
    .local v1, "$this$_get_Logout__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 36
    .local v2, "$i$a$-materialIcon$default-LogoutKt$Logout$1":I
    move-object v3, v1
    ...
    .local v27, "$this$_get_Logout__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 37
    .local v28, "$i$a$-materialPath-YwgOQQI$default-LogoutKt$Logout$1$1":I
    ...
    .end local v27    # "$this$_get_Logout__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_Logout__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-LogoutKt$Logout$1":I
    .local v41, "$i$a$-materialIcon$default-LogoutKt$Logout$1":I
    const/4 v2, 0x0
    ...
    .line 99
    .end local v0    # "$this$_get_Logout__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-LogoutKt$Logout$1$1":I
    nop
    ...
    .local v12, "$this$_get_Logout__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v15, 0x0

    .line 48
    .local v15, "$i$a$-materialPath-YwgOQQI$default-LogoutKt$Logout$1$2":I
    ...
    .line 137
    .end local v12    # "$this$_get_Logout__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v15    # "$i$a$-materialPath-YwgOQQI$default-LogoutKt$Logout$1$2":I
    nop
    ...
    .line 74
    .end local v1    # "$this$_get_Logout__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-LogoutKt$Logout$1":I
