...
.method public static final getSensors(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 40
    .param p0, "$this$Sensors"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.Sensors"
    ...
    .local v1, "$this$_get_Sensors__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SensorsKt$Sensors$1":I
    move-object v3, v1
    ...
    .local v16, "$this$_get_Sensors__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v34, 0x0

    .line 31
    .local v34, "$i$a$-materialPath-YwgOQQI$default-SensorsKt$Sensors$1$1":I
    ...
    .end local v16    # "$this$_get_Sensors__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v1, "$this$_get_Sensors__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v36, "$this$_get_Sensors__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    const v29, 0x4102e148    # 8.18f

    const v30, 0x410147ae    # 8.08f

    const v31, 0x410147ae    # 8.08f

    const v32, 0x4108a3d7    # 8.54f

    const v33, 0x4108a3d7    # 8.54f
    ...
    const v30, 0x4171eb85    # 15.12f

    const v31, 0x4171eb85    # 15.12f

    const v32, 0x41775c29    # 15.46f

    const v33, 0x41775c29    # 15.46f
    ...
    .end local v2    # "$i$a$-materialIcon$default-SensorsKt$Sensors$1":I
    .local v37, "$i$a$-materialIcon$default-SensorsKt$Sensors$1":I
    ...
    const v29, 0x41843d71    # 16.53f

    const/high16 v30, 0x41b00000    # 22.0f

    const v31, 0x4165c28f    # 14.36f
    ...
    invoke-virtual {v1, v3, v4, v0, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v29, 0x418b1eb8    # 17.39f

    const v30, 0x418fae14    # 17.96f

    const v31, 0x418fae14    # 17.96f

    const v32, 0x41928f5c    # 18.32f

    const v33, 0x41928f5c    # 18.32f
    ...
    .line 120
    .end local v1    # "$this$_get_Sensors__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v34    # "$i$a$-materialPath-YwgOQQI$default-SensorsKt$Sensors$1$1":I
    nop
    ...
    .line 95
    .end local v36    # "$this$_get_Sensors__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v37    # "$i$a$-materialIcon$default-SensorsKt$Sensors$1":I
