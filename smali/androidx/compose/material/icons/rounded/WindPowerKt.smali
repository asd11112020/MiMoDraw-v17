...
.method public static final getWindPower(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$WindPower"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.WindPower"
    ...
    .local v35, "$this$_get_WindPower__u24lambda_u247_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0
    ...
    .end local v35    # "$this$_get_WindPower__u24lambda_u247_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v24, "$this$_get_WindPower__u24lambda_u247_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 43
    .local v36, "$i$a$-materialPath-YwgOQQI$default-WindPowerKt$WindPower$1$2":I
    ...
    .end local v24    # "$this$_get_WindPower__u24lambda_u247_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v11, "$this$_get_WindPower__u24lambda_u247_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 196
    .end local v11    # "$this$_get_WindPower__u24lambda_u247_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-WindPowerKt$WindPower$1$2":I
    nop
    ...
    .local v12, "$this$_get_WindPower__u24lambda_u247_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 55
    .local v22, "$i$a$-materialPath-YwgOQQI$default-WindPowerKt$WindPower$1$3":I
    ...
    .line 234
    .end local v12    # "$this$_get_WindPower__u24lambda_u247_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-WindPowerKt$WindPower$1$3":I
    nop
    ...
    .local v15, "$this$_get_WindPower__u24lambda_u247_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 67
    .local v22, "$i$a$-materialPath-YwgOQQI$default-WindPowerKt$WindPower$1$4":I
    const v0, 0x415bae14    # 13.73f

    move/from16 v41, v2

    .end local v2    # "$i$a$-materialIcon$default-WindPowerKt$WindPower$1":I
    .local v41, "$i$a$-materialIcon$default-WindPowerKt$WindPower$1":I
    ...
    .end local v15    # "$this$_get_WindPower__u24lambda_u247_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_WindPower__u24lambda_u247_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    invoke-virtual/range {v15 .. v21}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveToRelative(FFFFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 272
    .end local v0    # "$this$_get_WindPower__u24lambda_u247_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-WindPowerKt$WindPower$1$4":I
    nop
    ...
    const v17, 0x41a4e148    # 20.61f

    const v18, 0x41b5ae14    # 22.71f
    ...
    const v20, 0x4148f5c3    # 12.56f

    const v21, 0x4166e148    # 14.43f
    ...
    .end local v41    # "$i$a$-materialIcon$default-WindPowerKt$WindPower$1":I
