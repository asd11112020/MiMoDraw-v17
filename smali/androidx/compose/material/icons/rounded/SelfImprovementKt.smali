...
.method public static final getSelfImprovement(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 45
    .param p0, "$this$SelfImprovement"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.SelfImprovement"
    ...
    .local v1, "$this$_get_SelfImprovement__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SelfImprovementKt$SelfImprovement$1":I
    move-object v3, v1
    ...
    .local v27, "$this$_get_SelfImprovement__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v28, 0x0

    .line 31
    .local v28, "$i$a$-materialPath-YwgOQQI$default-SelfImprovementKt$SelfImprovement$1$1":I
    ...
    .end local v27    # "$this$_get_SelfImprovement__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_SelfImprovement__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v44, "$i$a$-materialIcon$default-SelfImprovementKt$SelfImprovement$1":I
    ...
    invoke-virtual {v2, v0, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 115
    .end local v2    # "$this$_get_SelfImprovement__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v28    # "$i$a$-materialPath-YwgOQQI$default-SelfImprovementKt$SelfImprovement$1$1":I
    nop
    ...
    .local v12, "$this$_get_SelfImprovement__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 37
    .local v22, "$i$a$-materialPath-YwgOQQI$default-SelfImprovementKt$SelfImprovement$1$2":I
    ...
    invoke-virtual {v12, v15, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v12, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->horizontalLineTo(F)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v12, v11, v0, v15, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 153
    .end local v12    # "$this$_get_SelfImprovement__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-SelfImprovementKt$SelfImprovement$1$2":I
    nop
    ...
    .line 90
    .end local v1    # "$this$_get_SelfImprovement__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v44    # "$i$a$-materialIcon$default-SelfImprovementKt$SelfImprovement$1":I
