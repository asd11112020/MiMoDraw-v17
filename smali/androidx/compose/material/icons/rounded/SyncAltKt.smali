...
.method public static final getSyncAlt(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$SyncAlt"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.SyncAlt"
    ...
    .local v1, "$this$_get_SyncAlt__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SyncAltKt$SyncAlt$1":I
    move-object v3, v1
    ...
    .local v35, "$this$_get_SyncAlt__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-SyncAltKt$SyncAlt$1$1":I
    ...
    .end local v35    # "$this$_get_SyncAlt__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SyncAlt__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v30, 0x409147ae    # 4.54f

    const/high16 v31, 0x41900000    # 18.0f

    const v32, 0x409851ec    # 4.76f

    const/high16 v33, 0x41900000    # 18.0f

    const v34, 0x40a6b852    # 5.21f
    ...
    .line 42
    const v29, 0x41aeb852    # 21.84f

    const v30, 0x41028f5c    # 8.16f

    const v31, 0x41aeb852    # 21.84f

    const v32, 0x40fae148    # 7.84f

    const v33, 0x41ad3333    # 21.65f

    const v34, 0x40f4cccd    # 7.65f
    ...
    .line 102
    .end local v0    # "$this$_get_SyncAlt__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-SyncAltKt$SyncAlt$1$1":I
    nop
    ...
    .local v15, "$this$_get_SyncAlt__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 46
    .local v22, "$i$a$-materialPath-YwgOQQI$default-SyncAltKt$SyncAlt$1$2":I
    ...
    .end local v15    # "$this$_get_SyncAlt__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SyncAlt__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_SyncAlt__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v16, "$this$_get_SyncAlt__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    invoke-virtual {v0, v11, v1, v15, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 140
    .end local v0    # "$this$_get_SyncAlt__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-SyncAltKt$SyncAlt$1$2":I
    nop
    ...
    .line 77
    .end local v2    # "$i$a$-materialIcon$default-SyncAltKt$SyncAlt$1":I
    .end local v16    # "$this$_get_SyncAlt__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
