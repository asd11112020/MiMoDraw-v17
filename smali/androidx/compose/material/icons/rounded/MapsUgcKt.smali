...
.method public static final getMapsUgc(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$MapsUgc"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 30
    :cond_0
    const-string/jumbo v0, "Rounded.MapsUgc"
    ...
    .local v1, "$this$_get_MapsUgc__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v35, "$this$_get_MapsUgc__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 32
    .local v36, "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$1":I
    ...
    .end local v35    # "$this$_get_MapsUgc__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_MapsUgc__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v31, 0x41b5ae14    # 22.71f

    const v32, 0x4030a3d7    # 2.76f

    const v33, 0x41b3d70a    # 22.48f
    ...
    const v31, -0x3f74cccd    # -4.35f

    const v32, 0x410a8f5c    # 8.66f

    const v33, -0x3ef147ae    # -8.92f

    invoke-virtual/range {v27 .. v33}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveToRelative(FFFFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 52
    const v28, 0x41b43d71    # 22.53f

    const v29, 0x40e0f5c3    # 7.03f

    const v30, 0x418ecccd    # 17.85f
    ...
    .line 122
    .end local v2    # "$this$_get_MapsUgc__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$1":I
    nop
    ...
    .local v10, "$this$_get_MapsUgc__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v11, 0x0

    .line 57
    .local v11, "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$2":I
    ...
    .line 160
    .end local v10    # "$this$_get_MapsUgc__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v11    # "$i$a$-materialPath-YwgOQQI$default-MapsUgcKt$MapsUgc$1$2":I
    nop
    ...
    .line 97
    .end local v1    # "$this$_get_MapsUgc__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
