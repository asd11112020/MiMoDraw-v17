...
.method public static final getPunchClock(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$PunchClock"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.PunchClock"
    ...
    .local v1, "$this$_get_PunchClock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v35, "$this$_get_PunchClock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-PunchClockKt$PunchClock$1$1":I
    ...
    .end local v35    # "$this$_get_PunchClock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_PunchClock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-PunchClockKt$PunchClock$1":I
    ...
    invoke-virtual {v2, v0, v11, v3, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 116
    .end local v2    # "$this$_get_PunchClock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-PunchClockKt$PunchClock$1$1":I
    nop
    ...
    .local v11, "$this$_get_PunchClock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 61
    .local v12, "$i$a$-materialPath-YwgOQQI$default-PunchClockKt$PunchClock$1$2":I
    ...
    .end local v1    # "$this$_get_PunchClock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_PunchClock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    move-object v15, v11
    ...
    .line 154
    .end local v11    # "$this$_get_PunchClock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-PunchClockKt$PunchClock$1$2":I
    nop
    ...
    .line 91
    .end local v41    # "$i$a$-materialIcon$default-PunchClockKt$PunchClock$1":I
    .end local v42    # "$this$_get_PunchClock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
