...
.method public static final getTaxiAlert(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$TaxiAlert"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.TaxiAlert"
    ...
    .local v1, "$this$_get_TaxiAlert__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v35, "$this$_get_TaxiAlert__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$1":I
    ...
    .end local v35    # "$this$_get_TaxiAlert__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_TaxiAlert__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v31, -0x3f97ae14    # -3.63f

    const v32, -0x40bd70a4    # -0.76f

    const v33, -0x3f63851f    # -4.89f
    ...
    .local v41, "$i$a$-materialIcon$default-TaxiAlertKt$TaxiAlert$1":I
    ...
    const v32, 0x40cd70a4    # 6.42f

    const v33, 0x40828f5c    # 4.08f
    ...
    invoke-virtual {v0, v11, v3, v11, v8}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v3, v8, v3, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v3, v2, v3, v8}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 133
    .end local v0    # "$this$_get_TaxiAlert__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$1":I
    nop
    ...
    .local v11, "$this$_get_TaxiAlert__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0
    ...
    .end local v1    # "$this$_get_TaxiAlert__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_TaxiAlert__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 171
    .end local v11    # "$this$_get_TaxiAlert__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 108
    .end local v41    # "$i$a$-materialIcon$default-TaxiAlertKt$TaxiAlert$1":I
    .end local v42    # "$this$_get_TaxiAlert__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
