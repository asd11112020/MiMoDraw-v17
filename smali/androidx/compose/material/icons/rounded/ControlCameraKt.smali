...
.method public static final getControlCamera(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 45
    .param p0, "$this$ControlCamera"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.ControlCamera"
    ...
    .local v1, "$this$_get_ControlCamera__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-ControlCameraKt$ControlCamera$1":I
    move-object v3, v1
    ...
    .local v35, "$this$_get_ControlCamera__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-ControlCameraKt$ControlCamera$1$1":I
    ...
    .end local v35    # "$this$_get_ControlCamera__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_ControlCamera__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-ControlCameraKt$ControlCamera$1":I
    ...
    invoke-virtual {v2, v3, v0, v11, v4}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v4, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v2, v11, v4}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 124
    .end local v2    # "$this$_get_ControlCamera__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-ControlCameraKt$ControlCamera$1$1":I
    nop
    ...
    .local v11, "$this$_get_ControlCamera__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 77
    .local v12, "$i$a$-materialPath-YwgOQQI$default-ControlCameraKt$ControlCamera$1$2":I
    ...
    .line 162
    .end local v11    # "$this$_get_ControlCamera__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-ControlCameraKt$ControlCamera$1$2":I
    nop
    ...
    .line 99
    .end local v1    # "$this$_get_ControlCamera__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-ControlCameraKt$ControlCamera$1":I
