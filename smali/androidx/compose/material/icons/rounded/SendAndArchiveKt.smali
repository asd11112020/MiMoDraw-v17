...
.method public static final getSendAndArchive(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$SendAndArchive"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 35
    :cond_0
    const-string/jumbo v0, "Rounded.SendAndArchive"
    ...
    .line 36
    .local v2, "$i$a$-materialIcon$default-SendAndArchiveKt$SendAndArchive$1":I
    move-object v3, v1
    ...
    .local v35, "$this$_get_SendAndArchive__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 37
    .local v36, "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$1":I
    ...
    .end local v35    # "$this$_get_SendAndArchive__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_SendAndArchive__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-SendAndArchiveKt$SendAndArchive$1":I
    ...
    const v30, 0x419bae14    # 19.46f

    const v31, 0x418c51ec    # 17.54f

    const v32, 0x41993333    # 19.15f

    const v33, 0x418ecccd    # 17.85f
    ...
    .line 112
    .end local v2    # "$this$_get_SendAndArchive__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$1":I
    nop
    ...
    .local v11, "$this$_get_SendAndArchive__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 58
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$2":I
    ...
    .line 150
    .end local v11    # "$this$_get_SendAndArchive__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SendAndArchiveKt$SendAndArchive$1$2":I
    nop
    ...
    .end local v41    # "$i$a$-materialIcon$default-SendAndArchiveKt$SendAndArchive$1":I
