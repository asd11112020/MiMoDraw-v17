...
.method public static final getSpeakerNotesOff(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 40
    .param p0, "$this$SpeakerNotesOff"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.SpeakerNotesOff"
    ...
    .local v1, "$this$_get_SpeakerNotesOff__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SpeakerNotesOffKt$SpeakerNotesOff$1":I
    move-object v3, v1
    ...
    .local v34, "$this$_get_SpeakerNotesOff__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SpeakerNotesOffKt$SpeakerNotesOff$1$1":I
    ...
    .end local v34    # "$this$_get_SpeakerNotesOff__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v1, "$this$_get_SpeakerNotesOff__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v37, "$this$_get_SpeakerNotesOff__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .end local v2    # "$i$a$-materialIcon$default-SpeakerNotesOffKt$SpeakerNotesOff$1":I
    .local v38, "$i$a$-materialIcon$default-SpeakerNotesOffKt$SpeakerNotesOff$1":I
    ...
    invoke-virtual {v1, v8, v3, v2, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 63
    const v28, 0x41a91eb8    # 21.14f

    const v29, 0x418f999a    # 17.95f

    const/high16 v30, 0x41b00000    # 22.0f

    const v31, 0x4188a3d7    # 17.08f
    ...
    .line 118
    .end local v1    # "$this$_get_SpeakerNotesOff__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SpeakerNotesOffKt$SpeakerNotesOff$1$1":I
    nop
    ...
    .line 93
    .end local v37    # "$this$_get_SpeakerNotesOff__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v38    # "$i$a$-materialIcon$default-SpeakerNotesOffKt$SpeakerNotesOff$1":I
