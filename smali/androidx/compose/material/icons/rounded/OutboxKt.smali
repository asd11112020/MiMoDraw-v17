...
.method public static final getOutbox(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 44
    .param p0, "$this$Outbox"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.Outbox"
    ...
    .local v1, "$this$_get_Outbox__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v35, "$this$_get_Outbox__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$1":I
    ...
    .end local v35    # "$this$_get_Outbox__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_Outbox__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v41, "$i$a$-materialIcon$default-OutboxKt$Outbox$1":I
    ...
    .line 110
    .end local v0    # "$this$_get_Outbox__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$1":I
    nop
    ...
    .local v11, "$this$_get_Outbox__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 46
    .local v12, "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$2":I
    ...
    .end local v1    # "$this$_get_Outbox__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_Outbox__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 148
    .end local v11    # "$this$_get_Outbox__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-OutboxKt$Outbox$1$2":I
    nop
    ...
    .line 85
    .end local v41    # "$i$a$-materialIcon$default-OutboxKt$Outbox$1":I
    .end local v42    # "$this$_get_Outbox__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
