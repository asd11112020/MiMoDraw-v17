...
.method public static final getSpeakerPhone(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 45
    .param p0, "$this$SpeakerPhone"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.SpeakerPhone"
    ...
    .local v1, "$this$_get_SpeakerPhone__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v35, "$this$_get_SpeakerPhone__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-SpeakerPhoneKt$SpeakerPhone$1$1":I
    ...
    .end local v35    # "$this$_get_SpeakerPhone__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_SpeakerPhone__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v31, 0x412eb852    # 10.92f

    const v32, 0x40e0a3d7    # 7.02f

    const/high16 v33, 0x41400000    # 12.0f

    const v34, 0x40e0a3d7    # 7.02f
    ...
    .local v42, "$i$a$-materialIcon$default-SpeakerPhoneKt$SpeakerPhone$1":I
    ...
    const v30, 0x40d6147b    # 6.69f

    const v31, 0x40eae148    # 7.34f

    const v32, 0x40ed1eb8    # 7.41f

    const v33, 0x40f851ec    # 7.76f
    ...
    .line 118
    .end local v0    # "$this$_get_SpeakerPhone__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-SpeakerPhoneKt$SpeakerPhone$1$1":I
    nop
    ...
    .local v11, "$this$_get_SpeakerPhone__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 45
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SpeakerPhoneKt$SpeakerPhone$1$2":I
    ...
    .line 55
    const v16, 0x41883d71    # 17.03f

    const v17, 0x3ff70a3d    # 1.93f

    const v18, 0x4169eb85    # 14.62f
    ...
    .line 156
    .end local v11    # "$this$_get_SpeakerPhone__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SpeakerPhoneKt$SpeakerPhone$1$2":I
    nop
    ...
    .local v11, "$this$_get_SpeakerPhone__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 59
    .local v12, "$i$a$-materialPath-YwgOQQI$default-SpeakerPhoneKt$SpeakerPhone$1$3":I
    ...
    .end local v1    # "$this$_get_SpeakerPhone__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v40, "$this$_get_SpeakerPhone__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    move-object v15, v11
    ...
    .line 194
    .end local v11    # "$this$_get_SpeakerPhone__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-SpeakerPhoneKt$SpeakerPhone$1$3":I
    nop
    ...
    .line 93
    .end local v40    # "$this$_get_SpeakerPhone__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v42    # "$i$a$-materialIcon$default-SpeakerPhoneKt$SpeakerPhone$1":I
