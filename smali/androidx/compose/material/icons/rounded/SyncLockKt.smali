...
.method public static final getSyncLock(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 39
    .param p0, "$this$SyncLock"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.SyncLock"
    ...
    .local v1, "$this$_get_SyncLock__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-SyncLockKt$SyncLock$1":I
    move-object v3, v1
    ...
    .local v34, "$this$_get_SyncLock__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-SyncLockKt$SyncLock$1$1":I
    ...
    .end local v34    # "$this$_get_SyncLock__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v1, "$this$_get_SyncLock__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v37, "$this$_get_SyncLock__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    const v29, -0x3fb3d70a    # -3.19f

    const v30, 0x3fef5c29    # 1.87f

    const v31, -0x3f423d71    # -5.93f

    const v32, 0x4091eb85    # 4.56f

    const v33, -0x3f18f5c3    # -7.22f
    ...
    .end local v2    # "$i$a$-materialIcon$default-SyncLockKt$SyncLock$1":I
    .local v38, "$i$a$-materialIcon$default-SyncLockKt$SyncLock$1":I
    ...
    .line 129
    .end local v1    # "$this$_get_SyncLock__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-SyncLockKt$SyncLock$1$1":I
    nop
    ...
    .line 104
    .end local v37    # "$this$_get_SyncLock__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v38    # "$i$a$-materialIcon$default-SyncLockKt$SyncLock$1":I
