...
.method public static final getWifiPassword(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 39
    .param p0, "$this$WifiPassword"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.WifiPassword"
    ...
    .local v1, "$this$_get_WifiPassword__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-WifiPasswordKt$WifiPassword$1":I
    move-object v3, v1
    ...
    .local v34, "$this$_get_WifiPassword__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v35, 0x0

    .line 31
    .local v35, "$i$a$-materialPath-YwgOQQI$default-WifiPasswordKt$WifiPassword$1$1":I
    ...
    .end local v34    # "$this$_get_WifiPassword__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v1, "$this$_get_WifiPassword__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v37, "$this$_get_WifiPassword__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    const v29, 0x412ca3d7    # 10.79f

    const v30, 0x4166e148    # 14.43f
    ...
    const v30, -0x3f6a8f5c    # -4.67f

    const v31, 0x3f4a3d71    # 0.79f

    const v32, -0x3f3051ec    # -6.49f
    ...
    const v32, 0x4193eb85    # 18.49f

    const v33, 0x4142147b    # 12.13f
    ...
    .end local v2    # "$i$a$-materialIcon$default-WifiPasswordKt$WifiPassword$1":I
    .local v34, "$i$a$-materialIcon$default-WifiPasswordKt$WifiPassword$1":I
    ...
    invoke-virtual {v1, v0, v2, v3, v8}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 51
    const v28, 0x41bc147b    # 23.51f

    const v29, 0x4117851f    # 9.47f

    const v30, 0x41bbc28f    # 23.47f

    const v31, 0x41070a3d    # 8.44f
    ...
    invoke-virtual {v1, v3, v2, v0, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v1, v0, v3, v0, v8}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 122
    .end local v1    # "$this$_get_WifiPassword__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v35    # "$i$a$-materialPath-YwgOQQI$default-WifiPasswordKt$WifiPassword$1$1":I
    nop
    ...
    .line 97
    .end local v34    # "$i$a$-materialIcon$default-WifiPasswordKt$WifiPassword$1":I
    .end local v37    # "$this$_get_WifiPassword__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
