...
.method public static final getDataUsage(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 38
    .param p0, "$this$DataUsage"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.DataUsage"
    ...
    .local v1, "$this$_get_DataUsage__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-DataUsageKt$DataUsage$1":I
    move-object v3, v1
    ...
    .local v16, "$this$_get_DataUsage__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v34, 0x0

    .line 31
    .local v34, "$i$a$-materialPath-YwgOQQI$default-DataUsageKt$DataUsage$1$1":I
    ...
    .end local v1    # "$this$_get_DataUsage__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v36, "$this$_get_DataUsage__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .end local v16    # "$this$_get_DataUsage__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_DataUsage__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v37, "$i$a$-materialIcon$default-DataUsageKt$DataUsage$1":I
    ...
    const v31, -0x3efae148    # -8.32f

    const v32, -0x3f1d70a4    # -7.08f

    const v33, -0x3ee6e148    # -9.57f
    ...
    const v30, -0x400a3d71    # -1.92f

    const v31, 0x3ee147ae    # 0.44f

    const v32, -0x400a3d71    # -1.92f

    const v33, 0x3fb851ec    # 1.44f
    ...
    const v31, -0x3f275c29    # -6.77f

    const v32, 0x409a8f5c    # 4.83f

    const v33, -0x3f07ae14    # -7.76f
    ...
    const v30, -0x3f0ae148    # -7.66f

    const v31, 0x40bb851f    # 5.86f

    const v32, -0x3f20a3d7    # -6.98f
    ...
    const v29, 0x408c28f6    # 4.38f

    const v30, 0x408428f6    # 4.13f

    const v31, 0x40fd70a4    # 7.92f

    const v32, 0x410828f6    # 8.51f

    const v33, 0x410828f6    # 8.51f
    ...
    const v30, -0x3f9f5c29    # -3.51f

    const v31, 0x40033333    # 2.05f

    const v32, -0x3f48a3d7    # -5.73f
    ...
    .line 99
    .end local v2    # "$this$_get_DataUsage__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v34    # "$i$a$-materialPath-YwgOQQI$default-DataUsageKt$DataUsage$1$1":I
    nop
    ...
    .line 74
    .end local v36    # "$this$_get_DataUsage__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v37    # "$i$a$-materialIcon$default-DataUsageKt$DataUsage$1":I
