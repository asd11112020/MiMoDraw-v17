...
.method public static final getLockClock(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$LockClock"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.LockClock"
    ...
    .local v1, "$this$_get_LockClock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v35, "$this$_get_LockClock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0
    ...
    .end local v35    # "$this$_get_LockClock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_LockClock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-LockClockKt$LockClock$1":I
    ...
    const v29, 0x41a6f5c3    # 20.87f

    const/high16 v30, 0x41300000    # 11.0f

    const v31, 0x419beb85    # 19.49f
    ...
    .line 118
    .end local v2    # "$this$_get_LockClock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v11, "$this$_get_LockClock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 57
    .local v12, "$i$a$-materialPath-YwgOQQI$default-LockClockKt$LockClock$1$2":I
    ...
    .end local v1    # "$this$_get_LockClock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_LockClock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 156
    .end local v11    # "$this$_get_LockClock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-LockClockKt$LockClock$1$2":I
    nop
    ...
    .line 93
    .end local v41    # "$i$a$-materialIcon$default-LockClockKt$LockClock$1":I
    .end local v42    # "$this$_get_LockClock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
