...
.method public static final getPhonelinkLock(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$PhonelinkLock"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.PhonelinkLock"
    ...
    .local v1, "$this$_get_PhonelinkLock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-PhonelinkLockKt$PhonelinkLock$1":I
    move-object v3, v1
    ...
    .local v35, "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-PhonelinkLockKt$PhonelinkLock$1$1":I
    ...
    .end local v35    # "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 114
    .end local v0    # "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-PhonelinkLockKt$PhonelinkLock$1$1":I
    nop
    ...
    .local v15, "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 51
    .local v22, "$i$a$-materialPath-YwgOQQI$default-PhonelinkLockKt$PhonelinkLock$1$2":I
    ...
    .end local v15    # "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v35, "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_PhonelinkLock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v35    # "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v8, "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$this$_get_PhonelinkLock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    invoke-virtual {v8, v1, v15, v1, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 152
    .end local v8    # "$this$_get_PhonelinkLock__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-PhonelinkLockKt$PhonelinkLock$1$2":I
    nop
    ...
    .line 89
    .end local v2    # "$i$a$-materialIcon$default-PhonelinkLockKt$PhonelinkLock$1":I
    .end local v41    # "$this$_get_PhonelinkLock__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
