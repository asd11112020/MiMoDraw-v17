...
.method public static final getAddModerator(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 43
    .param p0, "$this$AddModerator"    # Landroidx/compose/material/icons/Icons$Rounded;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Rounded.AddModerator"
    ...
    .local v1, "$this$_get_AddModerator__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v35, "$this$_get_AddModerator__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-AddModeratorKt$AddModerator$1$1":I
    ...
    .end local v35    # "$this$_get_AddModerator__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_AddModerator__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-AddModeratorKt$AddModerator$1":I
    ...
    .line 42
    const v28, 0x412ccccd    # 10.8f

    const v29, 0x41a5ae14    # 20.71f
    ...
    .line 114
    .end local v2    # "$this$_get_AddModerator__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-AddModeratorKt$AddModerator$1$1":I
    nop
    ...
    .local v11, "$this$_get_AddModerator__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 47
    .local v12, "$i$a$-materialPath-YwgOQQI$default-AddModeratorKt$AddModerator$1$2":I
    ...
    .end local v1    # "$this$_get_AddModerator__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v42, "$this$_get_AddModerator__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 152
    .end local v11    # "$this$_get_AddModerator__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-AddModeratorKt$AddModerator$1$2":I
    nop
    ...
    .line 89
    .end local v41    # "$i$a$-materialIcon$default-AddModeratorKt$AddModerator$1":I
    .end local v42    # "$this$_get_AddModerator__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
