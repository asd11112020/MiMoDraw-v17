...
.method public static final getNightsStay(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$NightsStay"    # Landroidx/compose/material/icons/Icons$Outlined;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Outlined.NightsStay"
    ...
    .local v1, "$this$_get_NightsStay__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v35, "$this$_get_NightsStay__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-NightsStayKt$NightsStay$1$1":I
    ...
    .end local v35    # "$this$_get_NightsStay__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_NightsStay__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v41, "$i$a$-materialIcon$default-NightsStayKt$NightsStay$1":I
    ...
    const v30, -0x3f2dc28f    # -6.57f

    const v31, -0x4055c28f    # -1.33f

    const v32, -0x3ef51eb8    # -8.68f

    const v33, -0x3f523d71    # -5.43f
    ...
    const v29, 0x40e2e148    # 7.09f

    const v30, 0x40f7ae14    # 7.74f

    const v31, 0x411f0a3d    # 9.94f
    ...
    .line 102
    .end local v2    # "$this$_get_NightsStay__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-NightsStayKt$NightsStay$1$1":I
    nop
    ...
    .local v11, "$this$_get_NightsStay__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 50
    .local v12, "$i$a$-materialPath-YwgOQQI$default-NightsStayKt$NightsStay$1$2":I
    ...
    .line 140
    .end local v11    # "$this$_get_NightsStay__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-NightsStayKt$NightsStay$1$2":I
    nop
    ...
    .line 77
    .end local v1    # "$this$_get_NightsStay__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon$default-NightsStayKt$NightsStay$1":I
