...
.method public static final getSportsRugby(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 38
    .param p0, "$this$SportsRugby"    # Landroidx/compose/material/icons/Icons$Outlined;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Outlined.SportsRugby"
    ...
    .local v1, "$this$_get_SportsRugby__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v16, "$this$_get_SportsRugby__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v34, 0x0

    .line 31
    .local v34, "$i$a$-materialPath-YwgOQQI$default-SportsRugbyKt$SportsRugby$1$1":I
    ...
    .end local v1    # "$this$_get_SportsRugby__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v36, "$this$_get_SportsRugby__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .end local v16    # "$this$_get_SportsRugby__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v2, "$this$_get_SportsRugby__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v37, "$i$a$-materialIcon$default-SportsRugbyKt$SportsRugby$1":I
    ...
    const v31, -0x3f78a3d7    # -4.23f

    const v32, 0x40f66666    # 7.7f

    const v33, -0x3f63d70a    # -4.88f
    ...
    const v31, 0x418d1eb8    # 17.64f

    const v32, 0x40b6b852    # 5.71f

    const v33, 0x419251ec    # 18.29f
    ...
    const v29, 0x415547ae    # 13.33f

    const v30, 0x40ae147b    # 5.44f

    const v31, 0x41211eb8    # 10.07f
    ...
    const v30, -0x3f351eb8    # -6.34f

    const v31, 0x4047ae14    # 3.12f

    const v32, -0x3eff851f    # -8.03f

    const v33, 0x404c28f6    # 3.19f
    ...
    const v31, -0x3f6d70a4    # -4.58f

    const v32, 0x4093d70a    # 4.62f

    const v33, -0x3f2bd70a    # -6.63f

    invoke-virtual/range {v27 .. v33}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveToRelative(FFFFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 55
    const v28, 0x419ab852    # 19.34f

    const v29, 0x412ab852    # 10.67f

    const v30, 0x41947ae1    # 18.56f

    const v31, 0x415ee148    # 13.93f
    ...
    .line 100
    .end local v2    # "$this$_get_SportsRugby__u24lambda_u241_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v34    # "$i$a$-materialPath-YwgOQQI$default-SportsRugbyKt$SportsRugby$1$1":I
    nop
    ...
    .line 75
    .end local v36    # "$this$_get_SportsRugby__u24lambda_u241":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v37    # "$i$a$-materialIcon$default-SportsRugbyKt$SportsRugby$1":I
