...
.method public static final getDataObject(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$DataObject"    # Landroidx/compose/material/icons/Icons$Outlined;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Outlined.DataObject"
    ...
    .local v1, "$this$_get_DataObject__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0

    .line 30
    .local v2, "$i$a$-materialIcon$default-DataObjectKt$DataObject$1":I
    move-object v3, v1
    ...
    .local v35, "$this$_get_DataObject__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-DataObjectKt$DataObject$1$1":I
    ...
    .end local v35    # "$this$_get_DataObject__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_DataObject__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 124
    .end local v0    # "$this$_get_DataObject__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-DataObjectKt$DataObject$1$1":I
    nop
    ...
    .local v15, "$this$_get_DataObject__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 57
    .local v22, "$i$a$-materialPath-YwgOQQI$default-DataObjectKt$DataObject$1$2":I
    ...
    .end local v15    # "$this$_get_DataObject__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v8, "$this$_get_DataObject__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 162
    .end local v8    # "$this$_get_DataObject__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-DataObjectKt$DataObject$1$2":I
    nop
    ...
    .line 99
    .end local v1    # "$this$_get_DataObject__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v2    # "$i$a$-materialIcon$default-DataObjectKt$DataObject$1":I
