...
.method public static final getTaxiAlert(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 49
    .param p0, "$this$TaxiAlert"    # Landroidx/compose/material/icons/Icons$Outlined;
    ...
    .line 29
    :cond_0
    const-string/jumbo v0, "Outlined.TaxiAlert"
    ...
    .local v1, "$this$_get_TaxiAlert__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v2, 0x0
    ...
    .local v36, "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v37, 0x0

    .line 31
    .local v37, "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$1":I
    ...
    .end local v36    # "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 136
    .end local v0    # "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v37    # "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$1":I
    nop
    ...
    .local v16, "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v17, 0x0

    .line 37
    .local v17, "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$2":I
    move-object/from16 v8, v16

    const/high16 v11, 0x41780000    # 15.5f

    .end local v16    # "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v8, "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 174
    .end local v8    # "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v17    # "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$2":I
    nop
    ...
    .local v12, "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 43
    .local v22, "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$3":I
    ...
    .local v45, "$i$a$-materialIcon$default-TaxiAlertKt$TaxiAlert$1":I
    ...
    .line 212
    .end local v12    # "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$3":I
    nop
    ...
    .local v15, "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 75
    .local v22, "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$4":I
    ...
    .end local v15    # "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    invoke-virtual/range {v15 .. v21}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveToRelative(FFFFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v1    # "$this$_get_TaxiAlert__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .local v16, "$this$_get_TaxiAlert__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    invoke-virtual {v0, v15, v2, v15, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v1, v15, v2, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 250
    .end local v0    # "$this$_get_TaxiAlert__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-TaxiAlertKt$TaxiAlert$1$4":I
    nop
    ...
    .line 111
    .end local v16    # "$this$_get_TaxiAlert__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v45    # "$i$a$-materialIcon$default-TaxiAlertKt$TaxiAlert$1":I
