...
.method private static final BaselinesOffsetColumn(Ljava/util/List;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "C(BaselinesOffsetColumn)P(2,1)355@13242L1135:ListItem.kt#jmzs0o"
    ...
    const-string/jumbo v4, "androidx.compose.material.BaselinesOffsetColumn (ListItem.kt:354)"

    invoke-static {v0, v2, v3, v4}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V

    .line 356
    :cond_1
    new-instance v0, Landroidx/compose/material/ListItemKt$BaselinesOffsetColumn$1;

    move-object/from16 v10, p0

    invoke-direct {v0, v10}, Landroidx/compose/material/ListItemKt$BaselinesOffsetColumn$1;-><init>(Ljava/util/List;)V
    ...
    .local v15, "block$iv$iv":Lkotlin/jvm/functions/Function2;
    const/16 v16, 0x0
    ...
    invoke-interface {v13, v0, v15}, Landroidx/compose/runtime/Composer;->apply(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)V
    ...
    .line 446
    .end local v15    # "block$iv$iv":Lkotlin/jvm/functions/Function2;
    ...
    new-instance v11, Landroidx/compose/material/ListItemKt$BaselinesOffsetColumn$2;
    ...
    invoke-direct/range {v3 .. v8}, Landroidx/compose/material/ListItemKt$BaselinesOffsetColumn$2;-><init>(Ljava/util/List;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;II)V
...
.method public static final ListItem(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;ZLkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    .local v7, "secondaryText":Lkotlin/jvm/functions/Function2;
    :cond_19
    if-eqz v8, :cond_1a
    ...
    .local v2, "singleLineSecondaryText":Z
    goto :goto_11

    .line 79
    .end local v2    # "singleLineSecondaryText":Z
    ...
    .line 80
    .end local p3    # "singleLineSecondaryText":Z
    .local v23, "singleLineSecondaryText":Z
    :goto_11
    if-eqz v13, :cond_1b
    ...
    .local v14, "overlineText":Lkotlin/jvm/functions/Function2;
    :cond_1b
    if-eqz v15, :cond_1c
    ...
    .local v2, "trailing":Lkotlin/jvm/functions/Function2;
    goto :goto_12

    .line 81
    .end local v2    # "trailing":Lkotlin/jvm/functions/Function2;
    ...
    .line 82
    .end local p5    # "trailing":Lkotlin/jvm/functions/Function2;
    .local v15, "trailing":Lkotlin/jvm/functions/Function2;
    :goto_12
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
    ...
    const-string/jumbo v3, "androidx.compose.material.ListItem (ListItem.kt:83)"
    ...
    invoke-virtual {v2, v9, v3}, Landroidx/compose/material/MaterialTheme;->getTypography(Landroidx/compose/runtime/Composer;I)Landroidx/compose/material/Typography;

    move-result-object v24

    .line 87
    .local v24, "typography":Landroidx/compose/material/Typography;
    invoke-virtual/range {v24 .. v24}, Landroidx/compose/material/Typography;->getSubtitle1()Landroidx/compose/ui/text/TextStyle;

    move-result-object v2

    sget-object v4, Landroidx/compose/material/ContentAlpha;->INSTANCE:Landroidx/compose/material/ContentAlpha;

    invoke-virtual {v4, v9, v3}, Landroidx/compose/material/ContentAlpha;->getHigh(Landroidx/compose/runtime/Composer;I)F

    move-result v4

    invoke-static {v2, v4, v10}, Landroidx/compose/material/ListItemKt;->applyTextStyle(Landroidx/compose/ui/text/TextStyle;FLkotlin/jvm/functions/Function2;)Lkotlin/jvm/functions/Function2;
    ...
    invoke-virtual/range {v24 .. v24}, Landroidx/compose/material/Typography;->getBody2()Landroidx/compose/ui/text/TextStyle;

    move-result-object v2

    sget-object v5, Landroidx/compose/material/ContentAlpha;->INSTANCE:Landroidx/compose/material/ContentAlpha;

    invoke-virtual {v5, v9, v3}, Landroidx/compose/material/ContentAlpha;->getMedium(Landroidx/compose/runtime/Composer;I)F

    move-result v5

    invoke-static {v2, v5, v7}, Landroidx/compose/material/ListItemKt;->applyTextStyle(Landroidx/compose/ui/text/TextStyle;FLkotlin/jvm/functions/Function2;)Lkotlin/jvm/functions/Function2;

    move-result-object v25

    .line 89
    .local v25, "styledSecondaryText":Lkotlin/jvm/functions/Function2;
    invoke-virtual/range {v24 .. v24}, Landroidx/compose/material/Typography;->getOverline()Landroidx/compose/ui/text/TextStyle;

    move-result-object v2

    sget-object v5, Landroidx/compose/material/ContentAlpha;->INSTANCE:Landroidx/compose/material/ContentAlpha;

    invoke-virtual {v5, v9, v3}, Landroidx/compose/material/ContentAlpha;->getHigh(Landroidx/compose/runtime/Composer;I)F

    move-result v5

    invoke-static {v2, v5, v14}, Landroidx/compose/material/ListItemKt;->applyTextStyle(Landroidx/compose/ui/text/TextStyle;FLkotlin/jvm/functions/Function2;)Lkotlin/jvm/functions/Function2;

    move-result-object v26

    .line 90
    .local v26, "styledOverlineText":Lkotlin/jvm/functions/Function2;
    invoke-virtual/range {v24 .. v24}, Landroidx/compose/material/Typography;->getCaption()Landroidx/compose/ui/text/TextStyle;
    ...
    invoke-static {v2, v3, v15}, Landroidx/compose/material/ListItemKt;->applyTextStyle(Landroidx/compose/ui/text/TextStyle;FLkotlin/jvm/functions/Function2;)Lkotlin/jvm/functions/Function2;

    move-result-object v27

    .line 92
    .local v27, "styledTrailing":Lkotlin/jvm/functions/Function2;
    ...
    .line 94
    .local v28, "semanticsModifier":Landroidx/compose/ui/Modifier;
    if-nez v25, :cond_1e
    ...
    .line 95
    sget-object v2, Landroidx/compose/material/OneLine;->INSTANCE:Landroidx/compose/material/OneLine;
    ...
    .end local v7    # "secondaryText":Lkotlin/jvm/functions/Function2;
    .local v30, "secondaryText":Lkotlin/jvm/functions/Function2;
    move v7, v8

    move v8, v12

    invoke-virtual/range {v1 .. v8}, Landroidx/compose/material/OneLine;->ListItem(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    .end local v30    # "secondaryText":Lkotlin/jvm/functions/Function2;
    .restart local v1    # "$dirty":I
    .restart local v7    # "secondaryText":Lkotlin/jvm/functions/Function2;
    :cond_1e
    move/from16 v29, v1
    ...
    .restart local v30    # "secondaryText":Lkotlin/jvm/functions/Function2;
    if-nez v26, :cond_1f
    ...
    .line 99
    sget-object v12, Landroidx/compose/material/TwoLine;->INSTANCE:Landroidx/compose/material/TwoLine;
    ...
    .end local v14    # "overlineText":Lkotlin/jvm/functions/Function2;
    .local v2, "overlineText":Lkotlin/jvm/functions/Function2;
    move-object/from16 v14, v22

    move-object v1, v15

    .end local v15    # "trailing":Lkotlin/jvm/functions/Function2;
    .local v1, "trailing":Lkotlin/jvm/functions/Function2;
    move-object v15, v4
    ...
    invoke-virtual/range {v12 .. v21}, Landroidx/compose/material/TwoLine;->ListItem(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    .line 107
    .end local v1    # "trailing":Lkotlin/jvm/functions/Function2;
    .end local v2    # "overlineText":Lkotlin/jvm/functions/Function2;
    .restart local v14    # "overlineText":Lkotlin/jvm/functions/Function2;
    .restart local v15    # "trailing":Lkotlin/jvm/functions/Function2;
    :cond_21
    move-object v2, v14
    ...
    .end local v14    # "overlineText":Lkotlin/jvm/functions/Function2;
    .end local v15    # "trailing":Lkotlin/jvm/functions/Function2;
    .restart local v1    # "trailing":Lkotlin/jvm/functions/Function2;
    .restart local v2    # "overlineText":Lkotlin/jvm/functions/Function2;
    const v3, -0xc889e61
    ...
    .line 108
    sget-object v12, Landroidx/compose/material/ThreeLine;->INSTANCE:Landroidx/compose/material/ThreeLine;
    ...
    invoke-virtual/range {v12 .. v21}, Landroidx/compose/material/ThreeLine;->ListItem(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    .end local v24    # "typography":Landroidx/compose/material/Typography;
    .end local v25    # "styledSecondaryText":Lkotlin/jvm/functions/Function2;
    .end local v26    # "styledOverlineText":Lkotlin/jvm/functions/Function2;
    .end local v27    # "styledTrailing":Lkotlin/jvm/functions/Function2;
    .end local v28    # "semanticsModifier":Landroidx/compose/ui/Modifier;
    :cond_22
    move-object v12, v0
    ...
    .local v13, "trailing":Lkotlin/jvm/functions/Function2;
    .restart local v14    # "overlineText":Lkotlin/jvm/functions/Function2;
    :goto_14
    ...
    new-instance v16, Landroidx/compose/material/ListItemKt$ListItem$1;
...
.method private static final OffsetToBaselineOrCenter-Kz89ssw(FLandroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    .end local p3    # "$composer":Landroidx/compose/runtime/Composer;
    .local v9, "$composer":Landroidx/compose/runtime/Composer;
    const-string v1, "C(OffsetToBaselineOrCenter)P(2:c#ui.unit.Dp,1)397@14905L806:ListItem.kt#jmzs0o"
    ...
    const-string/jumbo v3, "androidx.compose.material.OffsetToBaselineOrCenter (ListItem.kt:396)"
    ...
    .line 398
    .local v11, "$i$a$-cache-ListItemKt$OffsetToBaselineOrCenter$1":I
    new-instance v12, Landroidx/compose/material/ListItemKt$OffsetToBaselineOrCenter$1$1;

    invoke-direct {v12, v6}, Landroidx/compose/material/ListItemKt$OffsetToBaselineOrCenter$1$1;-><init>(F)V

    check-cast v12, Landroidx/compose/ui/layout/MeasurePolicy;

    .line 471
    .end local v11    # "$i$a$-cache-ListItemKt$OffsetToBaselineOrCenter$1":I
    move-object v11, v12
    ...
    new-instance v13, Landroidx/compose/material/ListItemKt$OffsetToBaselineOrCenter$2;
...
.method private static final applyTextStyle(Landroidx/compose/ui/text/TextStyle;FLkotlin/jvm/functions/Function2;)Lkotlin/jvm/functions/Function2;
    ...
    .line 430
    .local v0, "lineHeightStyle":Landroidx/compose/ui/text/style/LineHeightStyle;
