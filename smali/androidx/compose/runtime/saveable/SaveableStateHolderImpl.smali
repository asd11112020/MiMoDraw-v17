...
.method public SaveableStateProvider(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string/jumbo v7, "androidx.compose.runtime.saveable.SaveableStateHolderImpl.SaveableStateProvider (SaveableStateHolder.kt:74)"
    ...
    .local v6, "$i$f$ReusableContent":I
    const v7, 0x1a7d48fd

    invoke-interface {v4, v7}, Landroidx/compose/runtime/Composer;->startReplaceableGroup(I)V

    const-string v7, "CC(ReusableContent)P(1)145@5313L9:Composables.kt#9igjgp"
    ...
    invoke-interface {v4, v7, v1}, Landroidx/compose/runtime/Composer;->startReusableGroup(ILjava/lang/Object;)V
    ...
    .line 77
    .local v9, "$i$a$-ReusableContent-SaveableStateHolderImpl$SaveableStateProvider$1":I
    const v10, 0x5a63e158

    const-string v11, "C76@3023L321,83@3357L150,87@3520L360:SaveableStateHolder.kt#r2ddri"
    ...
    .line 78
    .local v3, "$i$a$-remember-SaveableStateHolderImpl$SaveableStateProvider$1$registryHolder$1":I
    move/from16 v17, v3

    .end local v3    # "$i$a$-remember-SaveableStateHolderImpl$SaveableStateProvider$1$registryHolder$1":I
    .local v17, "$i$a$-remember-SaveableStateHolderImpl$SaveableStateProvider$1$registryHolder$1":I
    ...
    invoke-interface {v3, v1}, Landroidx/compose/runtime/saveable/SaveableStateRegistry;->canBeSaved(Ljava/lang/Object;)Z
    ...
    .line 82
    new-instance v3, Landroidx/compose/runtime/saveable/SaveableStateHolderImpl$RegistryHolder;

    invoke-direct {v3, v0, v1}, Landroidx/compose/runtime/saveable/SaveableStateHolderImpl$RegistryHolder;-><init>(Landroidx/compose/runtime/saveable/SaveableStateHolderImpl;Ljava/lang/Object;)V

    .line 148
    .end local v17    # "$i$a$-remember-SaveableStateHolderImpl$SaveableStateProvider$1$registryHolder$1":I
    nop
    ...
    .line 78
    .restart local v17    # "$i$a$-remember-SaveableStateHolderImpl$SaveableStateProvider$1$registryHolder$1":I
    :cond_2
    const/4 v3, 0x0

    .line 79
    .local v3, "$i$a$-require-SaveableStateHolderImpl$SaveableStateProvider$1$registryHolder$1$1":I
    move/from16 v18, v3

    .end local v3    # "$i$a$-require-SaveableStateHolderImpl$SaveableStateProvider$1$registryHolder$1$1":I
    ...
    .end local v6    # "$i$f$ReusableContent":I
    .local v19, "$i$f$ReusableContent":I
    const-string/jumbo v6, "Type of the key "
    ...
    .line 151
    .end local v17    # "$i$a$-remember-SaveableStateHolderImpl$SaveableStateProvider$1$registryHolder$1":I
    .end local v19    # "$i$f$ReusableContent":I
    .restart local v6    # "$i$f$ReusableContent":I
    :cond_3
    move/from16 v19, v6

    .end local v6    # "$i$f$ReusableContent":I
    .restart local v19    # "$i$f$ReusableContent":I
    move-object v3, v15
    ...
    .line 84
    invoke-static {v6, v2, v8, v10}, Landroidx/compose/runtime/CompositionLocalKt;->CompositionLocalProvider(Landroidx/compose/runtime/ProvidedValue;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V

    .line 88
    sget-object v6, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    new-instance v10, Landroidx/compose/runtime/saveable/SaveableStateHolderImpl$SaveableStateProvider$1$1;

    invoke-direct {v10, v0, v1, v3}, Landroidx/compose/runtime/saveable/SaveableStateHolderImpl$SaveableStateProvider$1$1;-><init>(Landroidx/compose/runtime/saveable/SaveableStateHolderImpl;Ljava/lang/Object;Landroidx/compose/runtime/saveable/SaveableStateHolderImpl$RegistryHolder;)V

    check-cast v10, Lkotlin/jvm/functions/Function1;

    const/4 v11, 0x6

    invoke-static {v6, v10, v8, v11}, Landroidx/compose/runtime/EffectsKt;->DisposableEffect(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V
    ...
    .end local v9    # "$i$a$-ReusableContent-SaveableStateHolderImpl$SaveableStateProvider$1":I
    nop
