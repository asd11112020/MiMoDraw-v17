...
.method public static synthetic takeNestedMutableSnapshot$default(Landroidx/compose/runtime/snapshots/MutableSnapshot;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
    ...
    const-string/jumbo p1, "Super calls with default arguments not supported in this target, function: takeNestedMutableSnapshot"
...
.method private final validateNotApplied()V
    ...
    const-string/jumbo v1, "Unsupported operation on a snapshot that has been applied"
...
.method private final validateNotAppliedOrPinned()V
    ...
    const-string/jumbo v1, "Unsupported operation on a disposed or applied snapshot"
...
.method public final innerApplyLocked$runtime_release(ILjava/util/Map;Landroidx/compose/runtime/snapshots/SnapshotIdSet;)Landroidx/compose/runtime/snapshots/SnapshotApplyResult;
    ...
    .line 907
    .local v4, "modified":Landroidx/compose/runtime/collection/IdentityArraySet;
    const/4 v5, 0x0
    ...
    .local v6, "this_$iv":Landroidx/compose/runtime/collection/IdentityArraySet;
    const/4 v7, 0x0
    ...
    .line 2372
    .local v8, "values$iv":[Ljava/lang/Object;
    const/4 v9, 0x0
    ...
    .local v0, "i$iv":I
    .local v5, "mergedRecords":Ljava/lang/Object;
    .local v9, "statesToRemove":Ljava/lang/Object;
    :goto_0
    if-ge v0, v10, :cond_d
    ...
    .local v11, "state":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v12, 0x0

    .line 909
    .local v12, "$i$a$-fastForEach-MutableSnapshot$innerApplyLocked$1":I
    ...
    .line 912
    .local v13, "first":Landroidx/compose/runtime/snapshots/StateRecord;
    move/from16 v14, p1

    move-object/from16 v15, p3

    invoke-static {v13, v14, v15}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$readable(Landroidx/compose/runtime/snapshots/StateRecord;ILandroidx/compose/runtime/snapshots/SnapshotIdSet;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .end local v6    # "this_$iv":Landroidx/compose/runtime/collection/IdentityArraySet;
    .local v16, "this_$iv":Landroidx/compose/runtime/collection/IdentityArraySet;
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getId()I

    move-result v6

    invoke-static {v13, v6, v3}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$readable(Landroidx/compose/runtime/snapshots/StateRecord;ILandroidx/compose/runtime/snapshots/SnapshotIdSet;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .line 2374
    .end local v11    # "state":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v12    # "$i$a$-fastForEach-MutableSnapshot$innerApplyLocked$1":I
    .end local v13    # "first":Landroidx/compose/runtime/snapshots/StateRecord;
    .end local v16    # "this_$iv":Landroidx/compose/runtime/collection/IdentityArraySet;
    .end local v17    # "current":Landroidx/compose/runtime/snapshots/StateRecord;
    .restart local v6    # "this_$iv":Landroidx/compose/runtime/collection/IdentityArraySet;
    :goto_1
    ...
    .end local v6    # "this_$iv":Landroidx/compose/runtime/collection/IdentityArraySet;
    .restart local v16    # "this_$iv":Landroidx/compose/runtime/collection/IdentityArraySet;
    goto/16 :goto_7

    .line 914
    .local v6, "previous":Landroidx/compose/runtime/snapshots/StateRecord;
    .restart local v11    # "state":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v12    # "$i$a$-fastForEach-MutableSnapshot$innerApplyLocked$1":I
    .restart local v13    # "first":Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .end local v8    # "values$iv":[Ljava/lang/Object;
    .local v19, "values$iv":[Ljava/lang/Object;
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getInvalid$runtime_release()Landroidx/compose/runtime/snapshots/SnapshotIdSet;

    move-result-object v8

    invoke-static {v13, v7, v8}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$readable(Landroidx/compose/runtime/snapshots/StateRecord;ILandroidx/compose/runtime/snapshots/SnapshotIdSet;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .local v8, "$this$innerApplyLocked_u24lambda_u2419_u24lambda_u2415":Landroidx/compose/runtime/snapshots/MutableSnapshot;
    const/16 v20, 0x0

    .line 917
    .local v20, "$i$a$-run-MutableSnapshot$innerApplyLocked$1$merged$1":I
    invoke-interface {v11, v6, v3, v7}, Landroidx/compose/runtime/snapshots/StateObject;->mergeRecords(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateRecord;)Landroidx/compose/runtime/snapshots/StateRecord;

    move-result-object v8

    .line 916
    .end local v8    # "$this$innerApplyLocked_u24lambda_u2419_u24lambda_u2415":Landroidx/compose/runtime/snapshots/MutableSnapshot;
    .end local v20    # "$i$a$-run-MutableSnapshot$innerApplyLocked$1$merged$1":I
    :cond_3
    nop
    ...
    new-instance v10, Landroidx/compose/runtime/snapshots/SnapshotApplyResult$Failure;

    move-object v2, v1

    check-cast v2, Landroidx/compose/runtime/snapshots/Snapshot;

    invoke-direct {v10, v2}, Landroidx/compose/runtime/snapshots/SnapshotApplyResult$Failure;-><init>(Landroidx/compose/runtime/snapshots/Snapshot;)V

    check-cast v10, Landroidx/compose/runtime/snapshots/SnapshotApplyResult;
    ...
    .local v20, "it":Ljava/util/List;
    const/16 v21, 0x0

    .line 928
    .local v21, "$i$a$-also-MutableSnapshot$innerApplyLocked$1$1":I
    ...
    .line 927
    .end local v20    # "it":Ljava/util/List;
    .end local v21    # "$i$a$-also-MutableSnapshot$innerApplyLocked$1$1":I
    move-object/from16 v23, v5
    ...
    .line 930
    .end local v5    # "mergedRecords":Ljava/lang/Object;
    .local v2, "mergedRecords":Ljava/lang/Object;
    :goto_2
    move-object/from16 v20, v2

    .end local v2    # "mergedRecords":Ljava/lang/Object;
    .local v20, "mergedRecords":Ljava/lang/Object;
    ...
    .line 935
    .local v21, "$i$a$-also-MutableSnapshot$innerApplyLocked$1$2":I
    move-object v9, v5
    ...
    .end local v21    # "$i$a$-also-MutableSnapshot$innerApplyLocked$1$2":I
    ...
    .line 937
    .end local v9    # "statesToRemove":Ljava/lang/Object;
    ...
    .end local v20    # "mergedRecords":Ljava/lang/Object;
    .local v5, "mergedRecords":Ljava/lang/Object;
    .restart local v9    # "statesToRemove":Ljava/lang/Object;
    :cond_7
    if-nez v5, :cond_8
    ...
    .line 942
    .local v21, "$i$a$-also-MutableSnapshot$innerApplyLocked$1$3":I
    move-object/from16 v5, v20
    ...
    .line 941
    .end local v20    # "it":Ljava/util/List;
    .end local v21    # "$i$a$-also-MutableSnapshot$innerApplyLocked$1$3":I
    move-object/from16 v23, v5
    ...
    .end local v2    # "mergedRecords":Ljava/lang/Object;
    .local v20, "mergedRecords":Ljava/lang/Object;
    invoke-virtual {v6}, Landroidx/compose/runtime/snapshots/StateRecord;->create()Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .end local v20    # "mergedRecords":Ljava/lang/Object;
    .restart local v5    # "mergedRecords":Ljava/lang/Object;
    :cond_a
    ...
    .end local v19    # "values$iv":[Ljava/lang/Object;
    .local v7, "$i$f$fastForEach":I
    .local v8, "values$iv":[Ljava/lang/Object;
    :cond_b
    move/from16 v17, v7
    ...
    .restart local v19    # "values$iv":[Ljava/lang/Object;
    :cond_c
    :goto_6
    nop
    ...
    .end local v6    # "previous":Landroidx/compose/runtime/snapshots/StateRecord;
    .end local v11    # "state":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v12    # "$i$a$-fastForEach-MutableSnapshot$innerApplyLocked$1":I
    .end local v13    # "first":Landroidx/compose/runtime/snapshots/StateRecord;
    :goto_7
    ...
    .restart local v8    # "values$iv":[Ljava/lang/Object;
    :cond_d
    move/from16 v14, p1
    ...
    .local v2, "state":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .local v17, "$i$a$-let-MutableSnapshot$innerApplyLocked$2":I
    move-object v3, v0

    check-cast v3, Landroidx/compose/runtime/snapshots/StateRecord;

    .line 960
    .local v3, "stateRecord":Landroidx/compose/runtime/snapshots/StateRecord;
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getId()I

    move-result v0

    invoke-virtual {v3, v0}, Landroidx/compose/runtime/snapshots/StateRecord;->setSnapshotId$runtime_release(I)V
    ...
    .local v22, "$i$a$-sync-MutableSnapshot$innerApplyLocked$2$1$1":I
    :try_start_0
    ...
    invoke-virtual {v3, v0}, Landroidx/compose/runtime/snapshots/StateRecord;->setNext$runtime_release(Landroidx/compose/runtime/snapshots/StateRecord;)V

    .line 963
    invoke-interface {v2, v3}, Landroidx/compose/runtime/snapshots/StateObject;->prependStateRecord(Landroidx/compose/runtime/snapshots/StateRecord;)V

    .line 964
    nop

    .end local v22    # "$i$a$-sync-MutableSnapshot$innerApplyLocked$2$1$1":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 2380
    .end local v2    # "state":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v3    # "stateRecord":Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .line 2382
    .restart local v2    # "state":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v3    # "stateRecord":Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .end local v17    # "$i$a$-let-MutableSnapshot$innerApplyLocked$2":I
    .end local v19    # "$i$f$sync":I
    .end local v20    # "lock$iv$iv":Ljava/lang/Object;
    .end local v21    # "$i$f$synchronized":I
    .local v2, "it":Ljava/util/List;
    ...
    .restart local v16    # "it":Ljava/util/List;
    .restart local v17    # "$i$a$-let-MutableSnapshot$innerApplyLocked$2":I
    nop
    ...
    invoke-virtual {v4, v11}, Landroidx/compose/runtime/collection/IdentityArraySet;->remove(Ljava/lang/Object;)Z
...
.method public nestedDeactivated$runtime_release(Landroidx/compose/runtime/snapshots/Snapshot;)V
    ...
    .line 825
    .local v0, "$i$a$-require-MutableSnapshot$nestedDeactivated$1":I
    nop

    .end local v0    # "$i$a$-require-MutableSnapshot$nestedDeactivated$1":I
    new-instance v0, Ljava/lang/IllegalArgumentException;

    const-string/jumbo v1, "no pending nested snapshots"
