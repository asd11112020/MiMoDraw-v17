...
.method public static final requestFocus(Landroidx/compose/ui/focus/FocusTargetNode;)Z
    ...
    .line 44
    .local v3, "$i$a$-withNewTransaction$default-FocusTransactionsKt$requestFocus$1":I
    sget-object v4, Landroidx/compose/ui/focus/FocusDirection;->Companion:Landroidx/compose/ui/focus/FocusDirection$Companion;

    invoke-virtual {v4}, Landroidx/compose/ui/focus/FocusDirection$Companion;->getEnter-dhqQ-8s()I

    move-result v4

    invoke-static {p0, v4}, Landroidx/compose/ui/focus/FocusTransactionsKt;->performCustomRequestFocus-Mxy_nc0(Landroidx/compose/ui/focus/FocusTargetNode;I)Landroidx/compose/ui/focus/CustomDestinationResult;
    ...
    .line 319
    .end local v3    # "$i$a$-withNewTransaction$default-FocusTransactionsKt$requestFocus$1":I
    nop
    ...
    .restart local v1    # "onCancelled$iv":Lkotlin/jvm/functions/Function0;
    .restart local v2    # "$i$f$withNewTransaction":I
    .restart local v3    # "$i$a$-withNewTransaction$default-FocusTransactionsKt$requestFocus$1":I
    :goto_1
    :try_start_1
    invoke-direct {v4}, Lkotlin/NoWhenBranchMatchedException;-><init>()V
    ...
    .end local v1    # "onCancelled$iv":Lkotlin/jvm/functions/Function0;
    .end local v2    # "$i$f$withNewTransaction":I
    .end local p0    # "$this$requestFocus":Landroidx/compose/ui/focus/FocusTargetNode;
    throw v4
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .restart local v1    # "onCancelled$iv":Lkotlin/jvm/functions/Function0;
    .restart local v2    # "$i$f$withNewTransaction":I
    .restart local p0    # "$this$requestFocus":Landroidx/compose/ui/focus/FocusTargetNode;
    :catchall_0
    move-exception v3
...
.method private static final requestFocusForChild(Landroidx/compose/ui/focus/FocusTargetNode;Landroidx/compose/ui/focus/FocusTargetNode;)Z
    ...
    .line 232
    .local v5, "$i$a$-also-FocusTransactionsKt$requestFocusForChild$2":I
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/focus/FocusTargetNode;->getFocusState()Landroidx/compose/ui/focus/FocusStateImpl;
    ...
    .end local v5    # "$i$a$-also-FocusTransactionsKt$requestFocusForChild$2":I
    move v15, v3
    ...
    .restart local v5    # "$i$a$-also-FocusTransactionsKt$requestFocusForChild$2":I
    :cond_27
    const/4 v2, 0x0

    .line 232
    .local v2, "$i$a$-check-FocusTransactionsKt$requestFocusForChild$2$1":I
    nop

    .end local v2    # "$i$a$-check-FocusTransactionsKt$requestFocusForChild$2$1":I
